# Endpoints — LegacySync (ETL/SSIS hacia Sistema Legado)

LegacySync no expone endpoints HTTP propios. Es el mecanismo de transferencia de datos **unidireccional** desde `ProquifaDotNet.Finanzas` y `ProquifaDotNet` hacia el sistema legado (PCconnect) mediante procesos SSIS / ETL.
