...
|-----------|-------|-------------|
| R16A-RE-FU-007 | T1 | ALTER FUNCTION fnEsProductoControlado para incluir clave 'origen' |
| R16A-RE-FU-010 | T3 | Endpoint de Cancelacion de pedido desde Tramitar Pedido |

---

## Tarea 1

**Titulo:** [ R16A-RE-FU-011 ] [ALG-BASIC-LOGIC] Validacion Back de restriccion regulatoria FAA y Remision con controlados
...
- Depende de: R16A-RE-FU-007 T1 (fnEsProductoControlado con 'origen')
...
- GAP-02 del archivo `R16A-RE-FU-011-Back.md`
- Criterio B1 del requisito (restriccion regulatoria)
- Regla 2 del requisito

**Recursos:**
- R16A-RE-FU-011-Back.md (Seccion C)
- R16A-RE-FU-011.md (Regla 2, Criterio B1)
...
**Titulo:** [ R16A-RE-FU-011 ] [IMP-EXIST-SERVICE] Verificar y asegurar asignacion de Controlados=1 en tpProformaPedido
...
**Mas informacion de la tarea:**
- GAP-03 del archivo `R16A-RE-FU-011-Back.md`
- Tabla: `tpProformaPedido` campo `Controlados`
- Criterio A1 del requisito

**Recursos:**
- R16A-RE-FU-011-Back.md (Seccion E)
- R16A-RE-FU-011_BD.md (Campos Clave)
...
**Titulo:** [ R16A-RE-FU-011 ] [IMP-EXIST-SERVICE] Verificacion del flujo completo Credito con controlados (MEX y PER)
...
- Depende de: R16A-RE-FU-007 T1 (fnEsProductoControlado), Tarea 1 y 2 de este requisito
...
**Recursos:**
- R16A-RE-FU-011-Back.md (todas las secciones)
- R16A-RE-FU-011.md (Criterios de Aceptacion)
