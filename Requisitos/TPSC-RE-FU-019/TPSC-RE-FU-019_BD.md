...
| Requisito | Relacion |
|-----------|----------|
| TPSC-RE-FU-018 | Pantalla inicial + creacion ProquifaDotNetTimbrado |
| TPSC-RE-FU-012 | Genera pendiente FAA desde Credito con FAA |
| TPSC-RE-FU-015 | Genera pendiente FAA desde Prepago con FAA |
| TPSC-RE-FU-016 | Patron persistencia Minio |
