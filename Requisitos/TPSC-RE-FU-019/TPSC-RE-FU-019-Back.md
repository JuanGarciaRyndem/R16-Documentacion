# Impacto en Back — TPSC-RE-FU-019
...
| Requisito | Relación |
|-----------|----------|
| TPSC-RE-FU-018 | Prerequisito: ProquifaDotNet.Timbrado creada + módulo FAA listado inicial |
| TPSC-RE-FU-016 | Prerequisito: ProquifaDotNet.Finanzas (solución base) |
| TPSC-RE-FU-012 | Genera pendiente FAA desde tramitación Crédito con FAA |
| TPSC-RE-FU-015 | Genera pendiente FAA desde tramitación Prepago con FAA |
| TPSC-RE-FU-005 | Brecha timbrado SUNAT Perú (bloquea FAA para Perú) |
