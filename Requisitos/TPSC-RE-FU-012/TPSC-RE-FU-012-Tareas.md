...
## T5 — [ TPSC-RE-FU-012 ] [ QUERY-G ] Análisis — Migración de transferencia Pedidos Crédito de SSIS a aplicativo
...
### Recursos
- `TPSC-RE-FU-028-Back.md` — patrón `IEtlLegacyTransferenciaService`, Brecha B3
- `TPSC-RE-FU-028-Tareas.md` — T17/T18/T19 (referencia del patrón de migración)
- `TPSC-RE-FU-010-Back.md`, `TPSC-RE-FU-011-Back.md`, `TPSC-RE-FU-012-Back.md` — secciones Transferencia a Legacy
...
### Recursos
- `TPSC-RE-FU-028-Tareas.md` — T18 (referencia del patrón builder + stub)
- Documento de análisis de T5
- `tpPedidoTramitarController.cs` — punto de invocación post-commit
- `TPSC-RE-FU-010-Back.md`, `TPSC-RE-FU-011-Back.md`, `TPSC-RE-FU-012-Back.md`
...
### Recursos
- `TPSC-RE-FU-028-Tareas.md` — T19 (referencia del patrón integración canal real + sustitución stub)
- Documento de análisis de T5
