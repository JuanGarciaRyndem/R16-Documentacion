...
| RT-06 | La leyenda ~~"OPERACIÓN AL CONTADO"~~ **"Contado"** (o "Crédito" según el caso — **[Resuelto, DUDA-043]**) es **texto fijo** de la plantilla (bloque PAGO del _B); no viaja en los datos. |
...
| 1.4 | 21 ago 2026 | Revisión de trazabilidad | Corrección — Criterio D5 y RT-06: la leyenda de pago confirmada por el cliente es "Contado"/"Crédito" (DUDA-043), no "OPERACIÓN AL CONTADO" como se había propuesto en v1.3. Sin cambio de alcance. | — |
