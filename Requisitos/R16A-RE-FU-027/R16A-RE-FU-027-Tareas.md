...
Ver sección *"Parte A / A1"* en `R16A-RE-FU-027-Back.md` y sección *"ALTER TABLE fccNotaCredito (soporte PEN)"* en `R16A-RE-FU-027_BD.md`.

**Recursos:**
- `R16A-RE-FU-027_BD.md` — ALTER TABLE fccNotaCredito
- `R16A-RE-FU-027-Back.md` — Parte A, sección A1
...
**Más información de la tarea:**
Ver sección *"Parte A / A2"* en `R16A-RE-FU-027-Back.md` y sección *"fccSaldoFavorCliente para Peru"* en `R16A-RE-FU-027_BD.md`.

**Recursos:**
- `R16A-RE-FU-027_BD.md` — fccSaldoFavorCliente para Perú
- `R16A-RE-FU-027-Back.md` — Parte A, sección A2
...
**Más información de la tarea:**
Ver sección *"Parte B / B1"* en `R16A-RE-FU-027-Back.md`. Ver regla 5 en `R16A-RE-FU-027.md`.

**Recursos:**
- `R16A-RE-FU-027-Back.md` — Parte B, sección B1
- `R16A-RE-FU-026-Tareas.md` — Tarea 4 (endpoint base a extender)
...
**Más información de la tarea:**
Ver sección *"Parte B / B2"* en `R16A-RE-FU-027-Back.md`. Ver regla 7 en `R16A-RE-FU-027.md`.

**Recursos:**
- `R16A-RE-FU-027-Back.md` — Parte B, sección B2
- `R16A-RE-FU-026-Tareas.md` — Tarea 5 (endpoint base a extender)
- `R16A-RE-FU-027_BD.md` — ALTER fccNotaCredito (campos PEN/MontoPEN)
...
**Más información de la tarea:**
Ver sección *"Parte B / B3"* en `R16A-RE-FU-027-Back.md`. Ver reglas 8-11 y 19-20 en `R16A-RE-FU-027.md`.

**Recursos:**
- `R16A-RE-FU-027-Back.md` — Parte B, sección B3
- `R16A-RE-FU-026-Tareas.md` — Tarea 6 (motor base a extender)
- `R16A-RE-FU-027.md` — Reglas 8-11, 19-20
...
**Más información de la tarea:**
Ver sección *"Parte B / B4"* en `R16A-RE-FU-027-Back.md`. Ver reglas 9-13 en `R16A-RE-FU-027.md`.

**Recursos:**
- `R16A-RE-FU-027-Back.md` — Parte B, sección B4
- `R16A-RE-FU-026-Tareas.md` — Tarea 7 (persistencia base a extender)
- `R16A-RE-FU-027_BD.md` — Tablas escritas runtime
...
**Más información de la tarea:**
Ver sección *"Parte B / B5"* en `R16A-RE-FU-027-Back.md`. Ver reglas 12-14 en `R16A-RE-FU-027.md`.

**Recursos:**
- `R16A-RE-FU-027-Back.md` — Parte B, sección B5
- `R16A-RE-FU-026-Tareas.md` — Tarea 8 (modal base a extender)
- `R16A-RE-FU-027.md` — Reglas 12-14
...
**Más información de la tarea:**
Ver sección *"Parte B / B6"* en `R16A-RE-FU-027-Back.md`. Ver reglas 15 y 16 en `R16A-RE-FU-027.md`.

**Recursos:**
- `R16A-RE-FU-027-Back.md` — Parte B, sección B6
- `R16A-RE-FU-026-Tareas.md` — Tarea 9 (auto-guardado base a extender)
- `R16A-RE-FU-027.md` — Reglas 15 y 16
