...
> está pendiente de definición (ver Brecha 5 de R16A-RE-FU-005 y Brechas B1–B4 de RE-FU-020).
...
confirmar (ver Regla 5 del requisito y Brecha B5 de R16A-RE-FU-020).
...
--    independiente — ver Tarea CREATE-PDF en R16A-RE-FU-029-Tareas.md.
```
