# R16A-RE-FU-001 — Tareas de Implementación Backend
...
### [R16A-RE-FU-001] [BD-OBJ-CH] Script de migración — `IdRegion` en `EmpresaDatosBancarios`
...
- GAP-01 del archivo `R16A-RE-FU-001-Back.md`
- Regla de negocio cubierta: **Regla 4** (consumo regionalizado)
- Ver diccionario de datos: `R16A-RE-FU-001_BD.md` — sección `EmpresaDatosBancarios`
- ⚠️ Ejecutar **antes** de Tarea 2

**Recursos:**
- Diccionario de datos: `Requisitos/R16A-RE-FU-001/R16A-RE-FU-001_BD.md`
- Análisis de impacto backend: `Requisitos/R16A-RE-FU-001/R16A-RE-FU-001-Back.md`
- Requisito funcional: `Requisitos/R16A-RE-FU-001/R16A-RE-FU-001.md`

---

## Tarea 2

### [R16A-RE-FU-001] [BD-OBJ-CH] Script de creación — Vista `vEmpresaDatosBancarios`
...
**Más información de la tarea:**
- GAP-02 del archivo `R16A-RE-FU-001-Back.md`
- Reglas de negocio cubiertas: **Regla 2** (vigencia), **Regla 4** (consumo regionalizado)
- Ver diccionario de datos: `R16A-RE-FU-001_BD.md` — sección `vEmpresaDatosBancarios`
...
### [R16A-RE-FU-001] [IMP-EXIST-SERVICE] Corregir `ObtenerTodos()` y actualizar modelo EF
...
**Más información de la tarea:**
- GAP-03 del archivo `R16A-RE-FU-001-Back.md`
...
### [R16A-RE-FU-001] [LIST-PAG-MULT-FILTER] Crear `vEmpresaDatosBancariosBO`
...
**Más información de la tarea:**
- GAP-04 del archivo `R16A-RE-FU-001-Back.md`
- Reglas de negocio cubiertas: **Regla 2** (vigencia), **Regla 4** (consumo regionalizado)
...
### [R16A-RE-FU-001] [LIST-MULT-FILTER] Crear `vEmpresaDatosBancariosController`
...
### [R16A-RE-FU-001] [UPDATE-DOC-PROD] Guía de Resolución para Soporte a la Producción
...
**Más información de la tarea:**
- Revisión aplicada: `R16A-RE-FU-001-Revision.md` — "Agregar requisito de mantenimiento post-go-live del catálogo"
...
- Diccionario de datos: `Requisitos/R16A-RE-FU-001/R16A-RE-FU-001_BD.md`
- Requisito funcional: `Requisitos/R16A-RE-FU-001/R16A-RE-FU-001.md`
- Revisión: `Requisitos/R16A-RE-FU-001/R16A-RE-FU-001-Revision.md`
