...
**Más información de la tarea:**
Ver sección *"Parte B / B3"* en `R16A-RE-FU-024-Back.md`.

**Recursos:**
- `R16A-RE-FU-024-Back.md` — Parte B, sección B3
- `R16A-RE-FU-024_BD.md` — catMoneda, catMedioDePago, EmpresaDatosBancarios
...
**Más información de la tarea:**
Ver sección *"Parte B / B2"* en `R16A-RE-FU-024-Back.md`. Ver criterios C1, C2, C3 en `R16A-RE-FU-024.md`.

**Recursos:**
- `R16A-RE-FU-024-Back.md` — Parte B, sección B2
- `R16A-RE-FU-024_BD.md` — Tablas leídas (CorreoRecibido, ArchivoCorreoRecibido)
