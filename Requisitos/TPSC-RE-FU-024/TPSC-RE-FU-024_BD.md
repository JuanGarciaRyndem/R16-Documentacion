...
| Requisito | Relación |
|-----------|----------|
| TPSC-RE-FU-008 | Buzón Cobros — `fccFolioPagoCliente` / `CorreoRecibidoCliente` |
| TPSC-RE-FU-023 | Pantalla principal VC — lista cobros pendientes |
| TPSC-RE-FU-025 | Paso 1 Perú — reutiliza toda esta estructura sin DDL nuevo |
| TPSC-RE-FU-026 | Paso 2 México — extiende `catTipoInconsistenciaCobro` y lee `fccPagoCliente` |
