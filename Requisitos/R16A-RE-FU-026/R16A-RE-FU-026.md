# R16A-RE-FU-026 — Validar Cobro: Paso 2 México
...
- ** DUDA ABIERTA — Moneda base del TC capturado: actualmente se utiliza MXN como moneda base para todas las conversiones (consistente con la regla SAT del CFDI). Pendiente validar con asesor fiscal y PROQUIFA si esta es la opción correcta o si en algún escenario operativo conviene capturar el TC vs moneda distinta. Misma duda que en R16A-RE-FU-024. **
