# Tareas Back — R16A-RE-FU-014
**Requisito:** Tramitación de pedidos Prepago sin controlados sin Factura por Adelantado

---

## T1 — [ R16A-RE-FU-014 ] [ALG-BASIC-LOGIC] Validación Back rechazar Entrega con Remisión en Prepago
...
## T2 — [ R16A-RE-FU-014 ] [ALG-BASIC-LOGIC] Validación datos facturación solo lectura en Prepago
...
## T3 — [ R16A-RE-FU-014 ] [ALG-BASIC-LOGIC] Verificar flujo sin controlados genera proforma correcta
...
|-----------|-------------------|----------|
| R16A-RE-FU-006 | ReferenciaPago | Se reconstruye según ese requisito |
| R16A-RE-FU-010 | Cancelación | Endpoint de cancelación se desarrolla en RE-FU-010 |
| R16A-RE-FU-013 | T1, T2, T3, T4, T6, T7 | Foliador, previsualización, envío correo, empresa, Perú, vinculación PDF |
