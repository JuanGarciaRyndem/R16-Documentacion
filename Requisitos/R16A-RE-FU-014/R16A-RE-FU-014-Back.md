# Impacto en Back — R16A-RE-FU-014
...
| GAP-04 | Cancelación del pedido | Dependencia de R16A-RE-FU-010 (endpoint de cancelación) | Referencia |
...
El requisito R16A-RE-FU-014 tiene **impacto bajo** en desarrollo Back. Es el flujo Prepago más común y **reutiliza íntegramente** los componentes desarrollados en RE-FU-013 (foliador, previsualización, envío correo, verificación Perú, vinculación PDF). Los gaps específicos son mínimos:
