# Tareas — R16A-RE-FU-006 Referencia Bancaria de Cliente
...
| **Total de tareas** | 8 |
| **Revisión aplicada** | R16A-RE-FU-006_Revision.md |

---

## Tarea 1

### R16A-RE-FU-006  GAP-01  [ CREATE-TABL-CH ] Crear tabla `ClienteDatosBancarios` en base de datos
...
- GAP-01 y Pendientes P2, P3 del archivo `R16A-RE-FU-006-Back.md`
- Reglas R2 y R3 del requisito: relación N:N cliente-cuenta y Código Validador por combinación

**Recursos:**
- Análisis de impacto backend: `Requisitos/R16A-RE-FU-006/R16A-RE-FU-006-Back.md`
- Diccionario de datos: `Requisitos/R16A-RE-FU-006/R16A-RE-FU-006_BD.md`
- Requisito funcional: `Requisitos/R16A-RE-FU-006/R16A-RE-FU-006.md`

---

## Tarea 2

### R16A-RE-FU-006  GAP-02  [ SERV-SIMPLE-PUT ] Crear `ClienteDatosBancariosBO` — CRUD de relación cliente-cuenta-CódigoValidador
...
**Más información de la tarea:**
- GAP-02 del archivo `R16A-RE-FU-006-Back.md`
...
### R16A-RE-FU-006  GAP-03  [ ALG-BASIC-LOGIC ] Crear `ReferenciaBancariaBO` — algoritmo de construcción de referencia bancaria (Banamex / no-Banamex)
...
**Más información de la tarea:**
- GAP-03 y Pendientes P1, P3 del archivo `R16A-RE-FU-006-Back.md`
...
### R16A-RE-FU-006  GAP-04  [ IMP-EXIST-SERVICE ] Inyectar `ReferenciaPago` en `tpProformaPedidoFactory`
...
**Más información de la tarea:**
- GAP-04 y Pendiente P7 del archivo `R16A-RE-FU-006-Back.md`
...
### R16A-RE-FU-006  GAP-05  [ SIMPLE-CRUD ] Crear `ClienteDatosBancariosController` — endpoint CRUD `/ClienteDatosBancarios`
...
**Más información de la tarea:**
- GAP-05 y Pendientes P4, P5 del archivo `R16A-RE-FU-006-Back.md`
...
### R16A-RE-FU-006  [ QUERY-G ]  ETL SSIS Clientes — Análisis de campos R16 a transferir a Legacy
...
### R16A-RE-FU-006  [ BD-OBJ-G ]  ETL SSIS Clientes — Actualización del paquete SSIS con campos R16
...
### R16A-RE-FU-006  [ QUERY-M ]  ETL SSIS Clientes — Pruebas de validación de datos transferidos a Legacy
