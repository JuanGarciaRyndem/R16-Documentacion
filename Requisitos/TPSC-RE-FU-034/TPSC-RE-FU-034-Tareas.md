...
**Objetivo general:**
Implementar `NCMexicoXmlBuilder` que recibe el `NCMexicoDto` y genera el `XDocument` CFDI 4.0 tipo E conforme al mapa de campos documentado en TPSC-RE-FU-034-Back.md, validado contra el ejemplo real B-128.
...
**Más información:**
Ver sección **Parte A** de `TPSC-RE-FU-034-Back.md` — mapa completo de campos CFDI 4.0 tipo E y validación contra ejemplo B-128.

**Recursos:**
- `TPSC-RE-FU-034-Back.md` — Parte A: Mapa de campos CFDI 4.0 tipo E
...
**Más información:**
Ver sección **Parte B** y **Parte D** de `TPSC-RE-FU-034-Back.md`.

**Recursos:**
- `TPSC-RE-FU-034-Back.md` — Partes B y D
