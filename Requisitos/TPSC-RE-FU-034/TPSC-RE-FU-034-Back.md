# Impacto en Backend — TPSC-RE-FU-034
...
Este requisito documenta el diseño e implementación de la capa de generación de documentos de la Nota de Crédito México. Es análogo a **TPSC-RE-FU-021** (Factura México) y cubre tres componentes principales:
...
**Namespace:** `ProquifaDotNet.Finanzas.Application.Services.NC.Mexico`  
**Patrón base:** `FacturaMexicoPdfMappingService` (TPSC-RE-FU-021)
...
- `GOL/MUN/PRO/PQF_MEX_FAC` (Factura México — TPSC-RE-FU-021)
...
**Patrón base:** `PersistirFacturaMexicoPdfService` (TPSC-RE-FU-021)
