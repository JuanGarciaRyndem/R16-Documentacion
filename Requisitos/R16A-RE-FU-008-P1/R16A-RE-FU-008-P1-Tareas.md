# Tareas — R16A-RE-FU-008 Propuesta 1

> **Requisito:** R16A-RE-FU-008 — Buzon de Cobros (Mailbot Rediseñado)
> **Propuesta:** P1 — Nueva solucion `MailbotWorker.sln` (.NET 10) + ajustes en ProquifaDotNet (Framework 4.8)
> **Analisis de impacto:** `R16A-RE-FU-008-P1-Back.md`
> **Total de tareas:** 17
...
### [R16A-RE-FU-008] [BD-OBJ-CH] Script de actualizacion de catalogos para Cobros
...
- Pendiente P2 del `R16A-RE-FU-008-P1-Back.md` debe resolverse antes de ejecutar este script
...
**Recursos:**
- Analisis de impacto backend: `Requisitos/R16A-RE-FU-008-P1/R16A-RE-FU-008-P1-Back.md`
- Diccionario de datos: `Requisitos/R16A-RE-FU-008-P1/R16A-RE-FU-008-P1_BD.md`
...
### [R16A-RE-FU-008] [BD-OBJ-M] Script de creacion de tablas de auditoria del Mailbot
...
**Mas informacion de la tarea:**
- Definicion completa de columnas en `R16A-RE-FU-008-P1_BD.md`
...
### [R16A-RE-FU-008] [IMP-EXIST-SERVICE] Refactorizar GeneradorProcesoMailBotBO y crear ClasificacionCorreoRecibidoConstants
...
**Mas informacion de la tarea:**
- GAP-01 y GAP-02 del archivo `R16A-RE-FU-008-P1-Back.md`
...
### [R16A-RE-FU-008] [SERV-COMPLEX-TRANSACT] Crear CorreoRecibidoClienteBuzonCobrosBO
...
**Mas informacion de la tarea:**
- GAP-03 del archivo `R16A-RE-FU-008-P1-Back.md`
- La segregacion por region es un criterio critico: "Correos MEX no aparecen en buzon PER y viceversa"

**Recursos:**
- Analisis de impacto backend: `Requisitos/R16A-RE-FU-008-P1/R16A-RE-FU-008-P1-Back.md`
- Requisito funcional: `Requisitos/R16A-RE-FU-008/R16A-RE-FU-008.md`
- Revision: `Requisitos/R16A-RE-FU-008/R16A-RE-FU-008 Revision.md`

---

## Tarea 5

### [R16A-RE-FU-008] [LIST-PAG-MULT-FILTER] Crear BuzonCobrosController en WebApi.Logistica
...
**Mas informacion de la tarea:**
- GAP-04 del archivo `R16A-RE-FU-008-P1-Back.md`
...
### [R16A-RE-FU-008] [ARQ-PROJ-NET] Crear solucion MailbotWorker.sln (.NET 10) — estructura base y scaffold de BD
...
**Mas informacion de la tarea:**
- Secciones 2 y 7 del archivo `R16A-RE-FU-008-P1-Back.md`
...
### [R16A-RE-FU-008] [IMPL-THIRD-SERV] Integrar n8n + RabbitMQ — configuracion del orquestador y consumers del Worker
...
**Mas informacion de la tarea:**
- Seccion 2.2 del archivo `R16A-RE-FU-008-P1-Back.md`
...
### [R16A-RE-FU-008] [ALG-COMPLX-LOGIC] Implementar Agente IA de clasificacion de correos
...
**Mas informacion de la tarea:**
- Seccion 3 del archivo `R16A-RE-FU-008-P1-Back.md`
...
### [R16A-RE-FU-008] [SERV-COMPLEX-TRANSACT] Implementar ProcesarCorreoUseCase y GenerarPendienteUseCase
...
**Mas informacion de la tarea:**
- Secciones 2 y 3 del archivo `R16A-RE-FU-008-P1-Back.md`
...
### [R16A-RE-FU-008] [IMPL-THIRD-SERV] Integrar MinIO — almacenamiento de adjuntos del Mailbot
...
**Mas informacion de la tarea:**
- Seccion 5 del archivo `R16A-RE-FU-008-P1-Back.md`
...
### [R16A-RE-FU-008] [ATTACHED-EMAIL] Integrar Brevo — notificaciones de error del Mailbot
...
**Mas informacion de la tarea:**
- Seccion 6 del archivo `R16A-RE-FU-008-P1-Back.md`
...
### [R16A-RE-FU-008] [AUTOMATIC-JOB] Configurar CorreoWorkerMex y CorreoWorkerPer como IHostedService
...
### [R16A-RE-FU-008] [SERV-COMPLEX-TRANSACT] Crear CorreoRecibidoClienteBuzonCotizacionesBO
...
- Patrón equivalente al GAP-03 del archivo `R16A-RE-FU-008-P1-Back.md`, pero para clasificación `Requisicion`
...
**Recursos:**
- Análisis de impacto backend: `Requisitos/R16A-RE-FU-008-P1/R16A-RE-FU-008-P1-Back.md`
...
### [R16A-RE-FU-008] [LIST-PAG-MULT-FILTER] Crear BuzonCotizacionesController en WebApi.Logistica
...
**Más información de la tarea:**
- Patrón equivalente al GAP-04 del archivo `R16A-RE-FU-008-P1-Back.md`, pero para el buzón de cotizaciones
...
### [R16A-RE-FU-008] [SERV-COMPLEX-TRANSACT] Crear CorreoRecibidoClienteBuzonPedidosBO
...
**Más información de la tarea:**
- Patrón equivalente al GAP-03 del archivo `R16A-RE-FU-008-P1-Back.md`, pero para clasificación `Pedido`
...
### [R16A-RE-FU-008] [LIST-PAG-MULT-FILTER] Crear BuzonPedidosController en WebApi.Logistica
...
**Más información de la tarea:**
- Patrón equivalente al GAP-04 del archivo `R16A-RE-FU-008-P1-Back.md`, pero para el buzón de pedidos
- Referencia de patrón: `BaseApiController.ObtenerUsuarioAutenticado()` en `Core.WebApi\ControllerOperations\BaseApiController.cs`
...
### [R16A-RE-FU-008] [IMP-EXIST-SERVICE] Actualizar lógica de clasificación y enrutamiento para Cotizaciones y Pedidos
...
**Recursos:**
- Análisis de impacto backend: `Requisitos/R16A-RE-FU-008-P1/R16A-RE-FU-008-P1-Back.md` — Sección 3.1 (flujo de clasificación) y Sección 4.1
