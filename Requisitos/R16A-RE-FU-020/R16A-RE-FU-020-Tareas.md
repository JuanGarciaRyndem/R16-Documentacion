...
- La tabla existe con la estructura definida en `R16A-RE-FU-020_BD.md`.
...
Ver sección *"Brecha Bloqueante: Datos Fiscales SUNAT del Producto"* en `R16A-RE-FU-020_BD.md`.

**Recursos:**
- `R16A-RE-FU-020_BD.md` — Script propuesto `CREATE TABLE catAfectacionIGV`
...
**Más información de la tarea:**
Ver sección *"Brecha Bloqueante: Datos Fiscales SUNAT del Producto"* en `R16A-RE-FU-020_BD.md`. Brecha 1 referenciada en `R16A-RE-FU-005`.

**Recursos:**
- `R16A-RE-FU-020_BD.md` — Script propuesto ALTER TABLE
...
**Más información de la tarea:**
Ver secciones *"EmpresaFolio GOLPERU"* y *"AppSetting ProquifaDotNetTimbrado (Peru)"* en `R16A-RE-FU-020_BD.md`.

**Recursos:**
- `R16A-RE-FU-020_BD.md` — Scripts propuestos INSERT
...
**Más información de la tarea:**
Ver sección *"Datos Legales Golocaer SAC"* en `R16A-RE-FU-020_BD.md`. Tarea bloqueada hasta recibir datos de la empresa.

**Recursos:**
- `R16A-RE-FU-020_BD.md` — Tabla de datos legales pendientes
...
**Más información de la tarea:**
Ver criterios A1–A4 y sección *"Estados del Pedido"* en `R16A-RE-FU-020-Pendiente.md` y `R16A-RE-FU-020_BD.md`.

**Recursos:**
- `R16A-RE-FU-020_BD.md` — Tablas leídas, tabla de estados FAA
- `R16A-RE-FU-020-Pendiente.md` — Reglas 3, 4, 16
...
**Más información de la tarea:**
Ver Reglas 6, 7, 12 y 17, y Riesgos 1 y 3 en `R16A-RE-FU-020-Pendiente.md`. Brecha 1 y Brecha 3 de `R16A-RE-FU-005`.

**Recursos:**
- `R16A-RE-FU-020_BD.md` — Tablas leídas, diferencias MEX vs PER
...
**Consideraciones previas:**
- El proveedor OSE/PSE para Perú está **pendiente de definir** (no se reutiliza el PAC de México). Brecha mayor documentada en Brecha 5 de `R16A-RE-FU-005`.
...
**Recursos:**
- `R16A-RE-FU-020_BD.md` — AppSetting SUNAT
...
**Más información de la tarea:**
Ver criterios E1–E3, Reglas 9–12, y sección *"Flujo de Datos — Paso 2 TIMBRAR"* en `R16A-RE-FU-020_BD.md`.

**Recursos:**
- `R16A-RE-FU-020_BD.md` — Flujo de datos
- `R16A-RE-FU-020-Pendiente.md` — Reglas 9, 10, 11, 12
...
**Consideraciones previas:**
- El diseño visual del PDF de la factura SUNAT Perú se documenta en R16A-RE-FU-022; esta tarea implementa la generación técnica del artefacto.
...
**Objetivo general:**
Implementar la generación del PDF de la Factura por Adelantado Perú (CPE tipo 01) con los datos del pedido, del cliente (RUC) y del emisor (Golocaer S.A.C.), conforme al formato visual definido en R16A-RE-FU-022.
...
**Resultado esperado:**
PDF de la Factura por Adelantado Perú generado correctamente en ambas fases (previsualización y definitivo), con el formato visual de R16A-RE-FU-022.

**Entregables:**
- Servicio/método de generación PDF para CPE tipo 01 Perú
- Plantilla PDF conforme a R16A-RE-FU-022
...
**Más información de la tarea:**
Ver criterio C1 y Regla 9 en `R16A-RE-FU-020-Pendiente.md`. Diseño visual en R16A-RE-FU-022.

**Recursos:**
- `R16A-RE-FU-020-Pendiente.md` — Regla 9, criterio C1
- R16A-RE-FU-022 — Estructura visual del PDF SUNAT
...
**Más información de la tarea:**
Ver criterios F1–F7, G1–G2, Reglas 13 y 14, y sección *"Flujo de Datos — Paso 3 ENVIAR"* en `R16A-RE-FU-020_BD.md`.

**Recursos:**
- `R16A-RE-FU-020_BD.md` — Flujo de datos paso 3
- `R16A-RE-FU-020-Pendiente.md` — Reglas 13, 14; criterios F1–G2
...
**Recursos:**
- `R16A-RE-FU-020_BD.md` — Diferencias MEX vs PER (sin Legacy, solo Prepago)
- `R16A-RE-FU-020-Pendiente.md` — Regla 15, criterio G3
