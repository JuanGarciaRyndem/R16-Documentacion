...
> **Nota:** Las filas marcadas *(→ RE-035)* corresponden a tareas de generación de documentos que pertenecen a **TPSC-RE-FU-035**. Se listan aquí para trazabilidad del orden de ejecución.
...
- **Prerrequisito:** TPSC-RE-FU-032 T1 debe estar ejecutado (columnas genéricas de NC ya existen en `fccNotaCredito`).
...
Ver sección *"ALTER TABLE fccNotaCredito — Columnas Perú"* en `TPSC-RE-FU-033_BD.md`.

**Recursos:**
- `TPSC-RE-FU-033_BD.md`
- `TPSC-RE-FU-032-Tareas.md` — T1 (columnas genéricas, prerrequisito)
...
**Más información de la tarea:**
Ver sección *"CREATE TABLE catMotivoCreditoSUNAT09"* en `TPSC-RE-FU-033_BD.md`.
...
**Más información de la tarea:**
Ver sección *"DML catTipoCFDI"* en `TPSC-RE-FU-033_BD.md`.

**Recursos:**
- `TPSC-RE-FU-033_BD.md`
- `TPSC-RE-FU-028-Tareas.md` — T1 (catTipoCFDI creado ahí)
...
**Más información de la tarea:**
Ver sección *"DML EmpresaFolio"* en `TPSC-RE-FU-033_BD.md`.
...
**Más información de la tarea:**
Ver sección *"DML DocumentTemplate"* en `TPSC-RE-FU-033_BD.md`.
...
**Más información de la tarea:**
Ver sección *"Parte B / B1"* en `TPSC-RE-FU-033-Back.md`.

**Recursos:**
- `TPSC-RE-FU-033-Back.md` — Parte B, sección B1
...
**Más información de la tarea:**
Ver secciones *"Parte B / B2, B3, B4"* en `TPSC-RE-FU-033-Back.md`.

**Recursos:**
- `TPSC-RE-FU-033-Back.md` — Parte B, secciones B2–B4
- `TPSC-RE-FU-032-Tareas.md` — T8 (patrón Wizard NC México)
...
**Más información de la tarea:**
Ver sección *"Parte C / C1"* en `TPSC-RE-FU-033-Back.md`.

**Recursos:**
- `TPSC-RE-FU-033-Back.md` — Parte C
...
**Más información de la tarea:**
Ver secciones *"Parte B / B7, B8, B9"* y *"Parte E"* en `TPSC-RE-FU-033-Back.md`.

**Recursos:**
- `TPSC-RE-FU-033-Back.md` — Parte B B7–B9, Parte E
