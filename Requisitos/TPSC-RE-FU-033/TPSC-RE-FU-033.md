...
- Timbrado del CPE ante SUNAT con feedback visual (en progreso / éxito / error) y previsualización del PDF antes de timbrar. ** La modalidad de emisión electrónica ante SUNAT está pendiente de definir (ver TPSC-RE-FU-029); no se da por hecho el uso de un OSE ni se reutiliza el PAC de México. **
...
## No aplica a
- Módulo NC para Región México: se documenta en TPSC-RE-FU-032.
- NCs para clientes de CRÉDITO (fuera de scope R16).
- Diseño del PDF representativo de la NC (layout, tipografía, secciones, branding, formato visual): se documenta en requisito independiente (TPSC-RE-FU-035). Esta fila cubre solo las funciones y la información del módulo.
...
Cuando el timbrado de la NC falla (validación, servicio indisponible, datos inválidos, error SUNAT), el sistema muestra un mensaje de error con el detalle, mismo comportamiento operativo que la facturación (TPSC-RE-FU-029). ** La modalidad de emisión electrónica ante SUNAT está pendiente de definir; no se da por hecho el uso de un OSE ni se reutiliza el PAC de México. **
...
La emisión de NCs depende de la modalidad de emisión electrónica que defina Golocaer ante SUNAT, pendiente de definir (brecha mayor compartida con TPSC-RE-FU-029). Mientras no se resuelva, no es posible timbrar NCs.
...
Entonces deberá conservar el XML, su constancia y su representación gráfica por 5 años (R.S. 117-2017/SUNAT), contados desde el 1 de enero del año siguiente al de emisión."								"- Fila para el módulo de Notas de Crédito de la Región Perú, contraparte de TPSC-RE-FU-032 (México). El PDF representativo de la NC se documenta aparte en TPSC-RE-FU-035.
