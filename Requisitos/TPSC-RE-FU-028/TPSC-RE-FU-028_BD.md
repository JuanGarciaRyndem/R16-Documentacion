...
| Requisito | Relación |
|-----------|----------|
| TPSC-RE-FU-019 | CFDIGenerada + EmpresaFolio + patrón timbrado en ProquifaDotNet.Timbrado |
| TPSC-RE-FU-024 / 026 | fccPagoCliente, fccPagoFacturaPedido (cobros y asociación Paso 1/Paso 2) |
| TPSC-RE-FU-026 | fccPagoFacturaAdelanto, fccNotaCredito (NCs con UUID para CFDIRelacionados) |
| TPSC-RE-FU-021 | Diseño PDF Factura México — DocumentBuilder |
| TPSC-RE-FU-013/014 | Genera `tpProformaPedido` con flag `HayControlados` (origen de la lógica condicional) |
| TPSC-RE-FU-015 | Genera pendiente FAA → `tpProformaAdelanto` usada en línea tipo COMPLEMENTO_PAGO |
