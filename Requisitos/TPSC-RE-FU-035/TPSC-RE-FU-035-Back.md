# Impacto en Backend — TPSC-RE-FU-035
...
Este requisito documenta el diseño e implementación de la capa de generación de documentos de la Nota de Crédito Perú. Es análogo a **TPSC-RE-FU-035** para Perú vs **TPSC-RE-FU-034** para México. Cubre tres componentes:
...
### Descripción
Clase responsable de construir el documento XML UBL 2.1 CPE tipo 07 a partir del `NCPeruDto`. Sigue el mismo patrón que `FacturaPeruXmlBuilder` (TPSC-RE-FU-022) pero para Nota de Crédito.
...
> ⚠️ **BLOQUEADO B1:** La implementación end-to-end del timbrado SUNAT (envío y recepción del CDR) depende de la modalidad de emisión electrónica que defina Golocaer ante SUNAT. Ver TPSC-RE-FU-029/033.
...
**Patrón base:** `FacturaPeruPdfMappingService` (TPSC-RE-FU-022)
...
### Identidad visual
- **Color corporativo:** Igual que `GOL_PER_FAC` (Factura Perú, TPSC-RE-FU-022).
...
**Patrón base:** `PersistirFacturaPeruPdfService` (TPSC-RE-FU-022)
