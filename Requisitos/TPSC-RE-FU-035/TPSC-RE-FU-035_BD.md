# Impacto en Base de Datos — TPSC-RE-FU-035
...
Este requisito **no introduce cambios nuevos en base de datos**. Toda la estructura de BD necesaria para la generación del CPE tipo 07 y el PDF de la NC Perú fue creada en el requisito **TPSC-RE-FU-033** (Notas de Crédito Perú — Módulo). TPSC-RE-FU-035 cubre únicamente la implementación del XML builder (UBL 2.1), el servicio de mapeo PDF y el diseño del template HTML.

---

## Prerrequisitos de BD — creados en TPSC-RE-FU-033
...
> **Nota adicional:** TPSC-RE-FU-032 T1 también es prerrequisito (columnas genéricas de NC en `fccNotaCredito`, base para las columnas Perú de RE-033 T1).
