...
```sql
-- ============================================================
-- R16A-NO-FU-001 T1 — ProquifaDotNetSendInBlue: tablas de configuración
-- Servidor: RYNL010
-- ============================================================
...
Ver sección 5.2 de `R16A-NO-FU-001.md` para el detalle completo de cada tabla y sus relaciones.

**Recursos:**
- `C:\Users\juan.garcia\Documents\R16-Documentacion\Requisitos\R16A-NO-FU-001\R16A-NO-FU-001.md` — Sección 5.2
...
```sql
-- ============================================================
-- R16A-NO-FU-001 T2 — Tablas operativas en ProquifaDotNetSendInBlue
-- ============================================================
...
**Más información de la tarea:**
Ver sección 6.1 de `R16A-NO-FU-001.md` para la estructura completa de la solución.

**Recursos:**
- `R16A-NO-FU-001.md` — Sección 6.1
...
**Recursos:**
- `R16A-NO-FU-001.md` — Sección 6.1 (Application)
...
**Recursos:**
- `R16A-NO-FU-001.md` — Secciones 6.1 y 6.4
...
## T11 — [ R16A-NO-FU-001 ] [CREATE-TABL-M] Crear tabla CatalogoPlantillaBrevo en ProquifaDotNetSendInBlue
...
```sql
-- ============================================================
-- R16A-NO-FU-001 T11 — CatalogoPlantillaBrevo en ProquifaDotNetSendInBlue
...
**Recursos:**
- `R16A-NO-FU-001.md` — Sección 5.2 (Base de datos ProquifaDotNetSendInBlue)
- Dependencia: T1

---

## T12 — [ R16A-NO-FU-001 ] [ALG-COMPLX-LOGIC] Implementar flujo de envío por plantilla Brevo nativa — Command, BrevoMailService, endpoint y Worker
...
- `R16A-NO-FU-001.md` — Secciones 6.1 (Application), 6.2 (API)
