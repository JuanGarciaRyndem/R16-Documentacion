...
- Para el detalle de los campos de la sección Cobros por Región, los catálogos y el análisis de los mecanismos tributarios peruanos, ver archivo adjunto `R16A-RE-FU-005_Equivalencias_Cobros_MX_PE.xlsx`.
