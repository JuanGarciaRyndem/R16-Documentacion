...
- **Campo "Tipo de Revisión":** corresponde al flujo de crédito y no tiene impacto en el alcance de R16.
- **Bandera Sujeto a Detracción:** la detracción SPOT no aplica a la operación de PROQUIFA — sin objeto al retirarse Perú del alcance de las banderas tributarias.
- **Bandera Agente de Retención de IGV, Agente de Percepción y denominación del campo Condición de Pago:** sin objeto al retirarse Perú del alcance de estas configuraciones.
