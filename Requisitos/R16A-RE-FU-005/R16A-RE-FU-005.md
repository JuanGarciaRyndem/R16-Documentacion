...
- **Catálogo definitivo de Forma de Pago México (2026-08-24):** el cliente entregó y confirmó cargado en `catMedioDePago` el listado final de 8 opciones (Efectivo, Cheque nominativo, Transferencia electrónica de fondos, Tarjeta de crédito, Tarjeta de débito, Aplicación de anticipos, Intermediario de pagos, Por definir), cada una con su clave SAT c_FormaPago. El catálogo anterior (10 registros ad-hoc, 4 de ellos sin clave SAT: Aba, NA, —NINGUNO—, Swift) queda reemplazado. **Pendiente:** confirmar si algún cliente tenía asignada alguna de esas 4 opciones retiradas, para aplicar la curaduría de la Regla 9. Detalle completo en `R16A-RE-FU-005_BD.md` y `R16A-RE-FU-005-Back.md`.
...
| 8 | 2026-08-24 | Catálogo definitivo de Forma de Pago México recibido | Sección "Resueltos" agrega el cierre del catálogo `catMedioDePago` México: 8 registros finales con clave SAT c_FormaPago, reemplazando el catálogo previo de 10 registros ad-hoc (4 sin clave SAT). Pendiente nuevo: confirmar curaduría de clientes que tuvieran asignada alguna de las 4 opciones retiradas (Regla 9). Detalle en `R16A-RE-FU-005_BD.md` y `R16A-RE-FU-005-Back.md`. |
