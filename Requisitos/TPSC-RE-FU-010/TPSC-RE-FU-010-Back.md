...
| Requisito | Relacion |
|-----------|----------|
| TPSC-RE-FU-003 | Pretramitacion del pedido (genera `ppPedido` que alimenta este flujo) |
| TPSC-RE-FU-006 | Referencia de pago bancaria en `tpProformaPedido` |
| TPSC-RE-FU-009 | Validacion regulatoria (productos controlados — excluidos de este flujo) |

---

## Conclusion

El requisito TPSC-RE-FU-010 tiene dos componentes:
