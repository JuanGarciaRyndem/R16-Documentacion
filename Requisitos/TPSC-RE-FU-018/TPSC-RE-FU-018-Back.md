# Impacto en Back - TPSC-RE-FU-018
...
> BD creada con script DDL documentado en TPSC-RE-FU-018_BD.md
...
| Requisito | Relacion |
|-----------|----------|
| TPSC-RE-FU-016 | Prerequisito: ProquifaDotNet.Finanzas ya creada (estructura, DI, API base) |
| TPSC-RE-FU-005 | Brecha timbrado SUNAT Peru (OSE) - bloquea flujo FAA para Peru |
