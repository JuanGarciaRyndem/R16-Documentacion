...
| Requisito | Relacion |
|-----------|----------|
| TPSC-RE-FU-012 | Genera pendiente FAA para Credito con FAA |
| TPSC-RE-FU-015 | Genera pendiente FAA para Prepago con FAA |
| TPSC-RE-FU-005 | Timbrado Peru (brecha) |
| TPSC-RE-FU-016 | Proforma MEX (flujo previo a FAA en Prepago) |
