...
**Titulo:** [ TPSC-RE-FU-018 ] [CONFIG-INIT] Crear solucion ProquifaDotNet.Timbrado con estructura Clean Architecture
...
**Recursos:**
- TPSC-RE-FU-018-Back.md (Parte A - Estructura de la Solucion)
...
**Titulo:** [ TPSC-RE-FU-018 ] [ARQ-PROJ-NET] Crear capa Domain - Entities, Interfaces y Models
...
- Las entidades reflejan exactamente la estructura de BD (TPSC-RE-FU-018_BD.md)
...
**Recursos:**
- TPSC-RE-FU-018-Back.md
- TPSC-RE-FU-018_BD.md

---

### Tarea 3

**Titulo:** [ TPSC-RE-FU-018 ] [ARQ-PROJ-NET] Crear capa Application - DTOs, Services y Validators
...
**Titulo:** [ TPSC-RE-FU-018 ] [SIMPLE-CRUD] Crear TimbradoContext con DbSet y mapping de entidades
...
**Recursos:**
- TPSC-RE-FU-018-Back.md
- TPSC-RE-FU-018_BD.md (DDL completo)

---

### Tarea 5

**Titulo:** [ TPSC-RE-FU-018 ] [IMPL-THIRD-SERV] Implementar SapTimbradoClient para integracion con PAC SAP
...
**Titulo:** [ TPSC-RE-FU-018 ] [IMP-EXIST-SERVICE] Implementar servicios de infraestructura - Minio, Brevo, RabbitMQ
...
**Titulo:** [ TPSC-RE-FU-018 ] [CONFIG-INIT] Crear capa API - Program.cs, Controllers y configuracion
...
**Titulo:** [ TPSC-RE-FU-018 ] [AUTOMATIC-JOB] Crear Worker.Timbrado para reintentos asincronos via RabbitMQ
...
**Recursos:**
- TPSC-RE-FU-018-Back.md (Flujo Asincrono Worker)

---

### Tarea 9

**Titulo:** [ TPSC-RE-FU-018 ] [CREATE-SCRIPT-CONTROL] Ejecutar scripts DDL para BD ProquifaDotNetTimbrado
...
**Recursos:**
- TPSC-RE-FU-018_BD.md (Script completo DDL)
...
**Titulo:** [ TPSC-RE-FU-018 ] [ALG-COMPLX-LOGIC] Crear FacturaAdelantadoRepository con query agrupada por cliente
...
**Recursos:**
- TPSC-RE-FU-018-Back.md (Cadena de Datos)
- TPSC-RE-FU-018_BD.md (Parte 1 - Lectura)

---

### Tarea 11

**Titulo:** [ TPSC-RE-FU-018 ] [LIST-PAG-MULT-FILTER] Crear FacturaAdelantadoService y Controller con endpoint listado
...
**Recursos:**
- TPSC-RE-FU-018-Back.md (Parte B)

---

### Tarea 12

**Titulo:** [ TPSC-RE-FU-018 ] [SIMPLE-CRUD] Ampliar FinanzasContext con DbSets para tablas FAA
...
**Recursos:**
- TPSC-RE-FU-018-Back.md
- TPSC-RE-FU-018_BD.md (Parte 1 - tablas consultadas)
...
**Titulo:** [ TPSC-RE-FU-018 ] [IMP-EXIST-SERVICE] Crear Servicio para consultar FAA en ProquifaDotNet con llamada a API Finanzas
...
**Recursos:**
- TPSC-RE-FU-018-Back.md (Parte C)
