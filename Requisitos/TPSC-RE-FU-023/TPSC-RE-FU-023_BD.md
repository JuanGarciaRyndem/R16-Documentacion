...
| Requisito      | Relación |
|----------------|----------|
| TPSC-RE-FU-008 | Buzón de Cobros — `CorreoRecibidoCliente`, clasificación 'cobro' Mailbot |
| TPSC-RE-FU-016 | Proforma MEX (`tpProformaPedido.MontoPendiente`) |
| TPSC-RE-FU-019 | FAA MEX genera pendientes en Validar Cobro (Prepago) |
| TPSC-RE-FU-020 | FAA PER genera pendientes en Validar Cobro |
| TPSC-RE-FU-024 | Confirmación cobro, folio COB, inconsistencias — reutiliza `fccPagoCliente` con campos ya incorporados en RE-FU-023 |
| TPSC-RE-FU-026 | Lee `fccPagoCliente` + `fccFolioPagoCliente` para Paso 2 Asociación |
