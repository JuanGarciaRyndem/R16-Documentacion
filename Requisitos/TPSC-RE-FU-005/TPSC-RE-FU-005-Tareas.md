# Tareas — TPSC-RE-FU-005 Catálogos de Cobros y Configuración de Facturación
...
| **Total de tareas** | 6 |
| **Revisión aplicada** | TPSC-RE-FU-005 Revision.md |

---
## Tarea 1

### TPSC-RE-FU-005  GAP-01  [ UPDATE-TABL-CH ] Agregar `IdRegion` a `catMetodoDePagoCFDI`, `catUsoCFDI` y `catMedioDePago`
...
- GAP-01 y Pendiente P2 del archivo `TPSC-RE-FU-005-Back.md`
- Regla R2 del requisito: catálogos diferenciados por Región

**Recursos:**
- Análisis de impacto backend: `Requisitos/TPSC-RE-FU-005/TPSC-RE-FU-005-Back.md`
- Diccionario de datos: `Requisitos/TPSC-RE-FU-005/TPSC-RE-FU-005_BD.md`
- Requisito funcional: `Requisitos/TPSC-RE-FU-005/TPSC-RE-FU-005.md`

---
## Tarea 2

### TPSC-RE-FU-005  GAP-02  [ QUERY-CH ] Insertar registros PE en `catMetodoDePagoCFDI` (CONT/CRED) y `catUsoCFDI` (01/03/08)
...
**Más información de la tarea:**
- GAP-02 y Pendiente P1 del archivo `TPSC-RE-FU-005-Back.md`
...
### TPSC-RE-FU-005  GAP-03  [ UPDATE-TABL-CH ] Agregar campos PE a `DatosFacturacionCliente` (`AgenteRetencionIGV`, `SujetoDetraccion`, `TasaDetraccion`)
...
**Más información de la tarea:**
- GAP-03 y Pendientes P3, P5, P6 del archivo `TPSC-RE-FU-005-Back.md`
...
### TPSC-RE-FU-005  GAP-04  [ IMP-EXIST-SERVICE ] Aplicar filtro de región en `catMetodoDePagoCFDIController`, `catUsoCFDIController` y `catMedioDePagoController`
...
**Más información de la tarea:**
- GAP-04 del archivo `TPSC-RE-FU-005-Back.md`
...
### TPSC-RE-FU-005  GAP-05  [ BD-OBJ-CH ] Revisar y actualizar `vDatosFacturacionCliente` para exponer campos PE
...
**Más información de la tarea:**
- GAP-05 del archivo `TPSC-RE-FU-005-Back.md`
...
### TPSC-RE-FU-005  GAP-06  [ QUERY-CH ] Completar `ClaveFormaDePago` en `catMedioDePago` para registros sin clave SAT
...
**Más información de la tarea:**
- GAP-06 y Pendiente P4 del archivo `TPSC-RE-FU-005-Back.md`
