...
|---|---|---|
| Catálogo de Clientes — Cobrador | TPSC-RE-FU-002 | `IdUsuarioCobrador` en `ClienteCartera` es el filtro de bandeja |
| Validar Cobro | TPSC-RE-FU-009 | El pendiente `fccFolioPagoCliente` se trabaja en Validar Cobro |
