# TPSC-RE-FU-027 — Validar Cobro: Paso 2 Perú
...
- Estructura UI idéntica a la de México (TPSC-RE-FU-026); las diferencias son exclusivamente catálogos y reglas fiscales.
...
- Wizard de Validar Cobro para Región México: se documenta en TPSC-RE-FU-026.
- Paso 1 (Captura del Cobro) y Paso 3 (Facturación y Envío) del wizard Perú: se documentan en TPSC-RE-FU-025 y TPSC-RE-FU-029.
...
- Generación de Notas de Crédito (emisión de nuevas NCs): se documenta en el módulo Notas de Crédito Perú (TPSC-RE-FU-033/035).
- Mecánica fiscal de referencia de la NC peruana (catálogo 09 SUNAT): se desarrolla en TPSC-RE-FU-033/035.
...
El Paso 2 del wizard de Validar Cobro de este requisito opera exclusivamente sobre clientes con Región Perú. Los clientes con Región México son atendidos por el wizard equivalente de México (TPSC-RE-FU-026). La UI es la misma; cambian los catálogos y las reglas fiscales.
...
La aplicación de Notas de Crédito al adeudo en el Paso 2 depende de la mecánica de referencia de la NC peruana (catálogo 09 SUNAT), que se define en TPSC-RE-FU-033/035 y aún no está validada para Perú.
...
Entonces el sistema deberá permitir seleccionar cero, una o varias NCs por documento; las no seleccionadas siguen vigentes. ** Mecánica fiscal de referencia de la NC peruana pendiente — ver TPSC-RE-FU-033/035. **
...
- Fila para el Paso 2 (Asociación) del wizard de Validar Cobro de la Región Perú, contraparte de TPSC-RE-FU-026 (México). Estado depende de la resolución de las brechas Perú.
...
- ** Pendiente — mecánica fiscal de referencia de la NC peruana (catálogo 09 SUNAT) al aplicarla al adeudo; se desarrolla en TPSC-RE-FU-033/035. **
...
- ** Pendiente — mecanismo de transferencia del estado "Pendiente de cancelación por falta de pago" para gestión externa; en Perú la cancelación fiscal sería vía Nota de Crédito SUNAT (TPSC-RE-FU-033/035). **
