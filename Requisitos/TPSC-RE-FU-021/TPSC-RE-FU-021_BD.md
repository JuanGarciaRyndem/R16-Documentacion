...
| Requisito | Relacion |
|-----------|----------|
| TPSC-RE-FU-019 | FAA MEX: dispara generacion de este PDF |
| TPSC-RE-FU-016 | Patron persistencia Minio (mismo bucket 'facturas') |
| TPSC-RE-FU-006 | REF.CLIENTE seccion bancaria |
| TPSC-RE-FU-001 | EmpresaDatosBancarios.IdRegion (cuentas MEX) |
