# Tareas — R16A-RE-FU-003 Catálogo de Clientes — Documentos Regulatorios
...
### R16A-RE-FU-003  GAP-01  [ IMP-EXIST-SERVICE ] Corregir lógica de reemplazo en `ArchivoClienteBO._GuardarOActualizar`
...
- GAP-01 del archivo `R16A-RE-FU-003-Back.md`
- Regla R3 del requisito: versión vigente única por tipo por cliente

**Recursos:**
- Análisis de impacto backend: `Requisitos/R16A-RE-FU-003/R16A-RE-FU-003-Back.md`
- Requisito funcional: `Requisitos/R16A-RE-FU-003/R16A-RE-FU-003.md`

---

## Tarea 2

### R16A-RE-FU-003  GAP-02  [ SERV-COMPLEX-TRANSACT ] Endpoint de carga de documento regulatorio (upload + validación PDF + reemplazo atómico)
...
**Más información de la tarea:**
- GAP-02 del archivo `R16A-RE-FU-003-Back.md`
...
**Recursos:**
- Análisis de impacto backend: `Requisitos/R16A-RE-FU-003/R16A-RE-FU-003-Back.md`
- Diccionario de datos: `Requisitos/R16A-RE-FU-003/R16A-RE-FU-003_BD.md`
- Requisito funcional: `Requisitos/R16A-RE-FU-003/R16A-RE-FU-003.md`
...
### R16A-RE-FU-003  GAP-03  [ LIST-MULT-FILTER ] Endpoint de consulta de documentos regulatorios vigentes por cliente
...
**Más información de la tarea:**
- GAP-03 del archivo `R16A-RE-FU-003-Back.md`
...
### R16A-RE-FU-003  GAP-04  [ IMP-EXIST-SERVICE ] Endpoint de entrega del PDF al navegador
...
**Más información de la tarea:**
- GAP-04 del archivo `R16A-RE-FU-003-Back.md`
...
### R16A-RE-FU-003  GAP-05  [ QUERY-CH ] Verificar y cargar datos iniciales en `catUsoArchivoSistema`
...
**Más información de la tarea:**
- GAP-05 y Pendiente P1 del archivo `R16A-RE-FU-003-Back.md`
...
### R16A-RE-FU-003  DOC-GUIDE — Guía de resolución: Alta, Baja y Actualización de documentos regulatorios por cliente
...
> ⚠️ Dar de baja ambos documentos de un cliente bloqueará la pretramitación de pedidos con sustancias controladas (R16A-RE-FU-009).
...
- Diccionario de datos: `Requisitos/R16A-RE-FU-003/R16A-RE-FU-003_BD.md`
- Requisito funcional: `Requisitos/R16A-RE-FU-003/R16A-RE-FU-003.md`
- Revisión funcional: `Requisitos/R16A-RE-FU-003/R16A-RE-FU-003_Revision.md`