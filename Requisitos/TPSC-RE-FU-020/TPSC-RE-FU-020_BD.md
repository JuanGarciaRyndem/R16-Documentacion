...
| Requisito | Relacion |
|-----------|----------|
| TPSC-RE-FU-018 | Pantalla inicial + ProquifaDotNetTimbrado |
| TPSC-RE-FU-019 | Detalle Mexico (infraestructura compartida) |
| TPSC-RE-FU-017 | PDF Proforma Peru (patron persistencia Minio PER) |
| TPSC-RE-FU-005 | Brechas Perú (B1 bloqueante, B5 timbrado) |
