# TPSC-RE-FU-007 — Tareas de Implementación Backend
...
### TPSC-RE-FU-007  [ BD-OBJ-M ] Modificar `fnEsProductoControlado` — agregar tipo de control `origen`
...
- GAP-01 del archivo `TPSC-RE-FU-007-Back.md`
...
- Diccionario de datos: `Requisitos/TPSC-RE-FU-007/TPSC-RE-FU-007_BD.md`
- Requisito funcional: `Requisitos/TPSC-RE-FU-007/TPSC-RE-FU-007.md`

---

## Tarea 2

### TPSC-RE-FU-007  [SERV-TRANSACT] Agregar detección de controlados y leyenda regulatoria en `_CotizacionUnitaria` — ProquifaDotNet
...
### TPSC-RE-FU-007  [ ALG-BASIC-LOGIC ] Agregar `RegulatoryNote` en `QuotationModel` — DocumentBuilder
...
**Más información de la tarea:**
- GAP-05 del archivo `TPSC-RE-FU-007-Back.md`
...
**Más información de la tarea:**
- GAP-06 del archivo `TPSC-RE-FU-007-Back.md`
