# R16A-NO-FU-002 — Tareas

## T1 — [ R16A-NO-FU-002 ] [CREATE-TABL-M] Crear tabla BitacoraTransaccion en ProquifaDotNet
...
- DDL: `CREATE TABLE BitacoraTransaccion` con 14 columnas según diccionario de datos de R16A-NO-FU-002.
...
```sql
-- ============================================================
-- R16A-NO-FU-002 T1 — BitacoraTransaccion en ProquifaDotNet
-- ============================================================
...
Ver sección 5.1 y 5.3 de R16A-NO-FU-002.md para DDL completo y diccionario.

**Recursos:**
- R16A-NO-FU-002.md — Secciones 5.1 y 5.3

---

## T2 — [ R16A-NO-FU-002 ] [UPDATE-TABL-CH] ALTER TABLE BitacoraCRUD — agregar IdBitacoraTransaccion
...
```sql
-- ============================================================
-- R16A-NO-FU-002 T2 — ALTER TABLE BitacoraCRUD
...
**Más información de la tarea:**
Ver sección 5.2 de R16A-NO-FU-002.md.

**Recursos:**
- R16A-NO-FU-002.md — Sección 5.2
- Dependencia: T1 (CREATE TABLE BitacoraTransaccion)

---

## T3 — [ R16A-NO-FU-002 ] [ALG-BASIC-LOGIC] Crear BitacoraTransaccionManager en Logic.Pqf.Catalogos
...
**Más información de la tarea:**
Ver secciones 4.3 y 6.2 de R16A-NO-FU-002.md para firma de métodos y pseudocódigo.

**Recursos:**
- R16A-NO-FU-002.md — Secciones 4.3 y 6.2
- `Logic.Pqf.Catalogos/ServiciosSistema/BitacoraMovimientos_.cs` — referencia de métodos HTTP
- Dependencias: T1, T2

---

## T4 — [ R16A-NO-FU-002 ] [IMP-EXIST-SERVICE] Integrar BitacoraTransaccionManager en ProductoTransaccionBO
...
**Recursos:**
- R16A-NO-FU-002.md — Sección 6.3
- `Logic.Pqf.Catalogos/Productos/ProductoTransaccionBO.cs`
- Dependencia: T3

---

## T5 — [ R16A-NO-FU-002 ] [ALG-BASIC-LOGIC] Crear endpoint BitacoraTransaccionController — consulta por transacción y por registro
...
**Más información de la tarea:**
Ver sección 6.4 de R16A-NO-FU-002.md.

**Recursos:**
- R16A-NO-FU-002.md — Sección 6.4
