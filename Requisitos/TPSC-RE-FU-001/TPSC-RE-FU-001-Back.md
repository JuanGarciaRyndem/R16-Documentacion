...
**Cambio requerido:** `ALTER TABLE` para agregar `IdRegion` FK → `Region`. Ver `TPSC-RE-FU-001_BD.md` para el script completo.
...
**Cambio requerido:** Crear `vEmpresaDatosBancarios` con JOIN completo. Ver `TPSC-RE-FU-001_BD.md` para el script.
