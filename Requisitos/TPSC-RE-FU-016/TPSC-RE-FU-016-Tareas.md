...
**Titulo:** [ TPSC-RE-FU-016 ] [CONFIG-INIT] Crear solucion ProquifaDotNet.Finanzas con estructura Clean Architecture
...
**Recursos:**
- TPSC-RE-FU-016-Back-Finanzas.md

---

### Tarea 2

**Titulo:** [ TPSC-RE-FU-016 ] [ARQ-PROJ-NET] Crear capa Domain - Common, Entities, Views e Interfaces
**Aplicativos:** ProquifaDotNet.Finanzas
**Modulos:** Domain
...
- Las entidades reflejan exactamente la estructura de BD (TPSC-RE-FU-016_BD.md v2.5)
...
**Recursos:**
- TPSC-RE-FU-016-Back-Finanzas.md
- TPSC-RE-FU-016_BD.md

---

### Tarea 3

**Titulo:** [ TPSC-RE-FU-016 ] [ARQ-PROJ-NET] Crear capa Application - DTOs, Interfaces, Mappers y Validators
**Aplicativos:** ProquifaDotNet.Finanzas
**Modulos:** Application
...
**Titulo:** [ TPSC-RE-FU-016 ] [ARQ-PROJ-NET] Crear capa Infrastructure - Repositories, Settings y Extensions
**Aplicativos:** ProquifaDotNet.Finanzas
...
**Titulo:** [ TPSC-RE-FU-016 ] [IMP-EXIST-SERVICE] Implementar servicios de infraestructura - Minio, Brevo, RabbitMQ, DocumentBuilder
**Aplicativos:** ProquifaDotNet.Finanzas
...
**Titulo:** [ TPSC-RE-FU-016 ] [CONFIG-INIT] Crear capa API - Program.cs y configuracion general
**Aplicativos:** ProquifaDotNet.Finanzas
**Modulos:** API
...
**Titulo:** [ TPSC-RE-FU-016 ] [SIMPLE-CRUD] Crear FinanzasContext con DbSet y mapping de entidades
**Aplicativos:** ProquifaDotNet.Finanzas
...
**Titulo:** [ TPSC-RE-FU-016 ] [SIMPLE-CRUD] Crear ProformaService y ProformaController con endpoints CRUD
**Aplicativos:** ProquifaDotNet.Finanzas
...
**Titulo:** [ TPSC-RE-FU-016 ] [LIST-PAG-MULT-FILTER] Crear servicio y controller para VtpProformaPedido con listado paginado
**Aplicativos:** ProquifaDotNet.Finanzas
**Modulos:** Application/Services, API/Controllers
...
**Titulo:** [ TPSC-RE-FU-016 ] [ALG-COMPLX-LOGIC] Crear modulo Proforma en Finanzas - Command/Query y endpoints de generacion PDF
**Aplicativos:** ProquifaDotNet.Finanzas
...
**Recursos:**
- TPSC-RE-FU-016-Back.md

---

### Tarea 11

**Titulo:** [ TPSC-RE-FU-016 ] [ALG-COMPLX-LOGIC] Crear DTO ProformaModel y BO de armado con datos de 15+ tablas
**Aplicativos:** ProquifaDotNet.Finanzas
...
**Titulo:** [ TPSC-RE-FU-016 ] [ALG-BASIC-LOGIC] Implementar foliador global con SEQUENCE y logica de Codigo Validador
**Aplicativos:** ProquifaDotNet.Finanzas
...
**Titulo:** [ TPSC-RE-FU-016 ] [ALG-BASIC-LOGIC] Implementar conversion de monto a letras (MXN y USD)
**Aplicativos:** ProquifaDotNet.Finanzas
**Modulos:** Application
...
**Titulo:** [ TPSC-RE-FU-016 ] [IMP-EXIST-SERVICE] Integracion Finanzas con DocumentBuilder y persistencia Minio
**Aplicativos:** ProquifaDotNet.Finanzas
...
**Titulo:** [ TPSC-RE-FU-016 ] [IMP-EXIST-SERVICE] Llamada a API Finanzas desde tramitacion en ProquifaDotNet
...
**Titulo:** [ TPSC-RE-FU-016 ] [IMPL-THIRD-SERV] Crear servicio GenerateProformaTemplate en DocumentBuilder
...
**Titulo:** [ TPSC-RE-FU-016 ] [CREATE-PDF] Crear 4 templates HTML de Proforma Mexico (12 archivos)
**Aplicativos:** DocumentBuilder
**Modulos:** Templates
...
**Titulo:** [ TPSC-RE-FU-016 ] [BD-OBJ-CH] Registrar templates de Proforma en BD DocumentBuilder y preparar logos
**Aplicativos:** DocumentBuilder
...
**Titulo:** [ TPSC-RE-FU-016 ] [SERV-TRANSACT] Implementar flujo transaccional de confirmacion de envio de Proforma
**Aplicativos:** ProquifaDotNet.Finanzas
**Modulos:** Application, Infrastructure
