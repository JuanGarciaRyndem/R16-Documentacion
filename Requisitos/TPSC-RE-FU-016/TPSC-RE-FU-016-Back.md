...
## Impacto en BD (según TPSC-RE-FU-016_BD.md v2.5)
...
| TPSC-RE-FU-013 | Flujo base Prepago (foliador, previsualización, envío) |
| TPSC-RE-FU-014 | Flujo Prepago sin FAA dispara generación del PDF |
| TPSC-RE-FU-017 | Proforma Perú (mismo patrón, templates diferentes) |
...
El requisito TPSC-RE-FU-016 tiene **impacto alto** en desarrollo. Involucra **3 repositorios**:
