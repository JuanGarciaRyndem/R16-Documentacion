# Tareas — R16A-RE-FU-004 Catálogo de Clientes — Información Fiscal
...
| **Total de tareas** | 6 |
| **Revisión aplicada** | R16A-RE-FU-004_Revision.md |

---

## Tarea 1

### R16A-RE-FU-004   [ QUERY-CH ] Corrección de catálogo `catRegimenFiscal` México — desactivar códigos derogados y no estándar SAT CFDI 4.0 - GAP-02a
...
- GAP-02 y Pendiente P1 del archivo `R16A-RE-FU-004-Back.md`
- Ver archivo adjunto `R16A-RE-FU-004_Equivalencias_MX_PE.xlsx` con el cruce de catálogos

**Recursos:**
- Análisis de impacto backend: `Requisitos/R16A-RE-FU-004/R16A-RE-FU-004-Back.md`
- Diccionario de datos: `Requisitos/R16A-RE-FU-004/R16A-RE-FU-004_BD.md`
- Requisito funcional: `Requisitos/R16A-RE-FU-004/R16A-RE-FU-004.md`

---

## Tarea 2

### R16A-RE-FU-004  [ QUERY-M ] Carga inicial de catálogos fiscales para Región Perú - GAP-02b 
...
**Más información de la tarea:**
- GAP-02 y Pendientes P2, P3, P4 del archivo `R16A-RE-FU-004-Back.md`
- Bloqueante para que la Tarea 5 (endpoints) funcione correctamente para Perú
- Ver `R16A-RE-FU-004_Equivalencias_MX_PE.xlsx` para el detalle del cruce
...
### R16A-RE-FU-004  [ UPDATE-TABL-CH ] Decisión de arquitectura y migración: campo `IdRegion` en catálogos fiscales - GAP-03 
...
**Más información de la tarea:**
- GAP-03 y Pendiente P8 del archivo `R16A-RE-FU-004-Back.md`
...
### R16A-RE-FU-004  [ UPDATE-TABL-CH ] Evaluar y corregir typo `TipoSociedadMerdantil` en `catTipoSociedadMercantil` - GAP-04
...
**Más información de la tarea:**
- GAP-04 y Pendiente P7 del archivo `R16A-RE-FU-004-Back.md`
...
### R16A-RE-FU-004  GAP-05  [ IMP-EXIST-SERVICE ] Aplicar filtro por región del usuario logueado en `catRegimenFiscalController` y `catTipoSociedadMercantilController` - GAP-05
...
**Más información de la tarea:**
- GAP-05 y Pendiente P8 del archivo `R16A-RE-FU-004-Back.md`
...
### R16A-RE-FU-004  GAP-01  [ ALG-BASIC-LOGIC ] Implementar validación de formato RUC Perú (Módulo 11) en `DatosFacturacionClienteBO` - GAP-01
...
**Más información de la tarea:**
- GAP-01 y Pendientes P5, P6 del archivo `R16A-RE-FU-004-Back.md`
