# Tareas Back - TPSC-RE-FU-013
**Requisito:** Tramitacion de pedidos Prepago con sustancias controladas

---

## T1 - [ TPSC-RE-FU-013 ] [ALG-COMPLX-LOGIC] Foliador lineal global de proforma
...
## T2 - [ TPSC-RE-FU-013 ] [ALG-BASIC-LOGIC] Verificar aplicabilidad del flujo por empresa
...
## T3 - [ TPSC-RE-FU-013 ] [IMP-EXIST-SERVICE] Previsualizacion obligatoria del PDF de proforma
...
## T4 - [ TPSC-RE-FU-013 ] [IMP-EXIST-SERVICE] Endpoint de envio de correo de proforma
...
## T5 - [ TPSC-RE-FU-013 ] [ALG-BASIC-LOGIC] Validaciones regulatorias para controlados
...
## T6 - [ TPSC-RE-FU-013 ] [ALG-BASIC-LOGIC] Verificacion operacion Peru
...
## T7 - [ TPSC-RE-FU-013 ] [ALG-BASIC-LOGIC] Vinculacion con generacion PDF de proforma (RE-FU-016/017)
...
| -------------- | ---------------------- | -------------------------------------------------------- |
| TPSC-RE-FU-006 | ReferenciaPago         | Se reconstruye segun ese requisito                       |
| TPSC-RE-FU-007 | fnEsProductoControlado | Deteccion de controlados con tipo Origen                 |
| TPSC-RE-FU-010 | Cancelacion            | Endpoint de cancelacion se desarrolla en RE-FU-010       |
| TPSC-RE-FU-016 | Generacion PDF         | Se desarrolla la generacion del PDF en DocumentBuilder   |
| TPSC-RE-FU-017 | Template PDF           | Se desarrolla el template de proforma en DocumentBuilder |
