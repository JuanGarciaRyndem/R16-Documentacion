# Impacto en Back - TPSC-RE-FU-013
...
| GAP-02 | Generacion PDF proforma via DocumentBuilder | **Se desarrolla en TPSC-RE-FU-016 y TPSC-RE-FU-017.** Se genera una tarea de vinculacion para integrar el PDF generado con el flujo de tramitacion | Referencia |
...
| TPSC-RE-FU-007 | fnEsProductoControlado (deteccion controlados con tipo Origen) |
| TPSC-RE-FU-010 | Cancelacion de pedido (endpoint compartido) |
| TPSC-RE-FU-016 | Generacion de PDF de proforma en DocumentBuilder |
...
El requisito TPSC-RE-FU-013 tiene **impacto medio** en desarrollo Back. El flujo base de generacion de proformas con controlados **ya existe**. Los gaps principales son:
