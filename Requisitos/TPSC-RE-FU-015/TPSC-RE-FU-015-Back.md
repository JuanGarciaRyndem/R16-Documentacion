# Impacto en Back — TPSC-RE-FU-015
...
| GAP-06 | Cancelación del pedido | Dependencia de TPSC-RE-FU-010 (endpoint de cancelación) | Referencia |
...
| TPSC-RE-FU-014 | Validaciones compartidas: Remisión Prepago, datos facturación |
...
| TPSC-RE-FU-018/019/020 | Módulo FAA consume el pendiente generado aquí |

---

## Conclusión

El requisito TPSC-RE-FU-015 tiene **impacto medio** en desarrollo Back. Reutiliza el flujo base de RE-FU-013/014 (proforma, foliador, previsualización, envío) pero agrega lógica específica:
