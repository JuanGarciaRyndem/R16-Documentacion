# [ R16A-RE-FU-008 ] [CONFIG-GMAIL] Configurar Gmail API watch por región (MEX/PER) con OAuth2
...
- Referencia: `R16A-RE-FU-008-v2_Propuesta2.md` — sección "Configuración Gmail API Watch"
