# [ R16A-RE-FU-008 ] [QUERY-CH] Scaffold EF Core de ProquifaDotNet en Mailbot.Infrastructure
...
- Referencia: `R16A-RE-FU-008-P2-Back.md` — PARTE 2, sección 2.4
- Comando: ver `R16A-RE-FU-008-v2_Propuesta2.md` — sección "Scaffold EF Core"
