# [ R16A-RE-FU-008 ] [IMP-EXIST-SERVICE] Actualizar GenerarPendienteUseCase — casos Cotizacion y Pedido en MailbotWorker (.NET 10)
...
- Referencia: `R16A-RE-FU-008-P2-Back.md` — PARTE 2, sección 2.6 (flujo end-to-end, actualmente solo documenta cobro)
