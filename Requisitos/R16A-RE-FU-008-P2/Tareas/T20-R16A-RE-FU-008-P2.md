# [ R16A-RE-FU-008 ] [SERV-COMPLEX-TRANSACT] Implementar Mailbot.Api — endpoints webhook + middleware + health
...
- Referencia: `R16A-RE-FU-008-v2_Propuesta2.md` — secciones "Payload del Push" y "Configuración Gmail API Watch"
