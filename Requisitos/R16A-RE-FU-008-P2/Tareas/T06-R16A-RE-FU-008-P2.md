# [ R16A-RE-FU-008 ] [SERV-SIMPLE-PUT] Crear BuzonCobrosBO.Reclasificar — reclasificación manual de correo
...
- Query: `R16A-RE-FU-008_BD.md` — sección "Reclasificar correo a otro buzón"
