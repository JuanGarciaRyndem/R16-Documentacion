# [ R16A-RE-FU-008 ] [ARQ-PROJ-NET] Implementar Mailbot.Domain — entidades e interfaces
...
- Referencia: `R16A-RE-FU-008-v2_Propuesta2.md` — sección "Arquitectura de la Solución" (Mailbot.Domain)
