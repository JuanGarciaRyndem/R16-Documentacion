# Impacto en Back — TPSC-RE-FU-032
...
> Ver script completo en `TPSC-RE-FU-032_BD.md` — ALTER TABLE fccNotaCredito.
...
> Ver script completo en `TPSC-RE-FU-032_BD.md` — ALTER TABLE fccNotaCreditoPartida.
...
> Ver script en `TPSC-RE-FU-032_BD.md` — DML DocumentTemplate.
...
El diseño del PDF de la NC se documenta en un requisito independiente (análogo a TPSC-RE-FU-021 para Factura México). Esta sección cubre únicamente el registro de los `TemplateKey` en BD y la integración funcional.
