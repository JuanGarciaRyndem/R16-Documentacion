1# Tareas BackEnd — TPSC-RE-FU-032
...
> **Nota:** Las filas marcadas *(→ RE-034)* corresponden a tareas de generación de documentos que pertenecen a **TPSC-RE-FU-034**. Se listan aquí para trazabilidad del orden de ejecución. Las tareas propias de este requisito (RE-032) son T1–T9 y T10–T14.
...
Ver sección *"ALTER TABLE fccNotaCredito — Columnas R16"* en `TPSC-RE-FU-032_BD.md` y sección *"Parte A / A1"* en `TPSC-RE-FU-032-Back.md`.

**Recursos:**
- `TPSC-RE-FU-032_BD.md` — ALTER TABLE fccNotaCredito
...
**Más información de la tarea:**
Ver sección *"ALTER TABLE fccNotaCreditoPartida — Columnas R16"* en `TPSC-RE-FU-032_BD.md` y sección *"Parte A / A2"* en `TPSC-RE-FU-032-Back.md`.

**Recursos:**
- `TPSC-RE-FU-032_BD.md` — ALTER TABLE fccNotaCreditoPartida
...
**Más información de la tarea:**
Ver sección *"DML catUsoCFDI"* en `TPSC-RE-FU-032_BD.md` y sección *"Parte A / A3"* en `TPSC-RE-FU-032-Back.md`.

**Recursos:**
- `TPSC-RE-FU-032_BD.md` — DML catUsoCFDI
...
**Consideraciones previas:**
- **Prerrequisito:** La tabla `catTipoCFDI` es creada por TPSC-RE-FU-028 Tarea 1. Esta tarea no puede ejecutarse hasta que RE-028 T1 esté completa.
...
**Más información de la tarea:**
Ver sección *"DML catTipoCFDI"* en `TPSC-RE-FU-032_BD.md` y sección *"Parte A / A4"* en `TPSC-RE-FU-032-Back.md`.

**Recursos:**
- `TPSC-RE-FU-032_BD.md` — DML catTipoCFDI
- `TPSC-RE-FU-028-Tareas.md` — Tarea 1 (catTipoCFDI)
...
**Más información de la tarea:**
Ver sección *"DML EmpresaFolio"* en `TPSC-RE-FU-032_BD.md` y sección *"Parte A / A5"* en `TPSC-RE-FU-032-Back.md`.

**Recursos:**
- `TPSC-RE-FU-032_BD.md` — DML EmpresaFolio
...
**Más información de la tarea:**
Ver sección *"DML DocumentTemplate"* en `TPSC-RE-FU-032_BD.md` y sección *"Parte A / A6"* en `TPSC-RE-FU-032-Back.md`.

**Recursos:**
- `TPSC-RE-FU-032_BD.md` — DML DocumentTemplate
...
**Más información de la tarea:**
Ver sección *"Parte C / C1"* en `TPSC-RE-FU-032-Back.md`.

**Recursos:**
- `TPSC-RE-FU-032-Back.md` — Parte C, sección C1
...
**Más información de la tarea:**
Ver secciones *"Parte B / B1, B2, B3"* en `TPSC-RE-FU-032-Back.md`.

**Recursos:**
- `TPSC-RE-FU-032-Back.md` — Parte B, secciones B1–B3
...
- `PersistirNCMexicoPdfService` es implementado en **TPSC-RE-FU-034 T6**. Esta tarea lo consume; asegurarse de que RE-034 T6 esté completada antes de integrarse end-to-end.
...
**Más información de la tarea:**
Ver sección *"Parte B / B6, B7, B8"* y *"Parte E"* en `TPSC-RE-FU-032-Back.md`.

**Recursos:**
- `TPSC-RE-FU-032-Back.md` — Parte B sección B6, Parte E
...
**Más información de la tarea:**
Ver sección *"catMotivoCancelacionSAT"* en `TPSC-RE-FU-032_BD.md`.

**Recursos:**
- `TPSC-RE-FU-032_BD.md` — catMotivoCancelacionSAT
...
**Recursos:**
- `TPSC-RE-FU-032_BD.md` — catMotivoCancelacionSAT
- `TPSC-RE-FU-032-Back.md` — Parte B, sección B6 (cancelación condicional)
...
- Referencia de datos fuente ya documentada en `TPSC-RE-FU-032-Back.md` sección F3.
...
**Más información de la tarea:**
Ver sección *"Parte F"* en `TPSC-RE-FU-032-Back.md`.

**Recursos:**
- `TPSC-RE-FU-032-Back.md` — Parte F (ETL PCconnect)
...
**Más información de la tarea:**
Ver sección *"Parte F / F2, F3, F4"* en `TPSC-RE-FU-032-Back.md`.

**Recursos:**
- `TPSC-RE-FU-032-Back.md` — Parte F
