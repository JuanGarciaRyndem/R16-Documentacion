...
| 4   | DML EmpresaFolio — INSERT Serie NC Perú para Golocaer S.A.C.                                                                                               | ProquifaDotNet (Finanzas) | DML       | Alta      |
...
| —   | Reutiliza: `EmpresaFolio` — estructura existente (RE-019); Serie NC en cambio #4                                                                           | ProquifaDotNet (Finanzas) | Existente | —         |
