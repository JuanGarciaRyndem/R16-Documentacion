...
- La tabla existe con la estructura definida en `TPSC-RE-FU-022_BD.md`.
...
Ver sección *"CREATE TABLE CPEGenerada"* y *"Columnas de CPEGenerada"* en `TPSC-RE-FU-022_BD.md`. Ver sección *"Decisión: CPEGenerada vs reutilizar CFDIGenerada"* para justificación del diseño.

**Recursos:**
- `TPSC-RE-FU-022_BD.md` — Script propuesto `CREATE TABLE CPEGenerada`
- `TPSC-RE-FU-022-Back.md` — Parte C, paso 1
...
**Más información de la tarea:**
Ver sección *"Vinculación CPEGenerada con tpProformaAdelanto"* en `TPSC-RE-FU-022_BD.md`. Ver `TPSC-RE-FU-022-Back.md` Parte C, paso 2.

**Recursos:**
- `TPSC-RE-FU-022_BD.md` — Script propuesto ALTER tpProformaAdelanto
- `TPSC-RE-FU-022-Back.md` — Parte C, paso 2
...
**Más información de la tarea:**
Ver criterios A1-J2 en `TPSC-RE-FU-022-Pendiente.md`. Ver sección *"Parte A — DocumentBuilder"* en `TPSC-RE-FU-022-Back.md`. Patrón de templates en `Scripts/20251001_1439/01_Insert_templates.sql` de DocumentBuilder.

**Recursos:**
- `TPSC-RE-FU-022-Pendiente.md` — Criterios A1-J2
- `TPSC-RE-FU-022-Back.md` — Parte A, estructura del template
...
**Más información de la tarea:**
Ver sección *"Parte B — FacturaPeruPdfMappingService"* en `TPSC-RE-FU-022-Back.md`. Ver Tarea 4 de RE-FU-020 (datos SUNAT del producto como prerequisito). Es el contraparte peruano de la Tarea 9 de RE-FU-021.

**Recursos:**
- `TPSC-RE-FU-022-Back.md` — Parte B, modelo y flujo MapearAsync
- `TPSC-RE-FU-022-Pendiente.md` — Criterios A1-J2, Reglas 7 y 8
- TPSC-RE-FU-021 Tarea 9 — `FacturaMexicoPdfMappingService` (patrón equivalente)
...
**Más información de la tarea:**
Ver sección *"Parte B — PersistirFacturaPeruPdfService"* en `TPSC-RE-FU-022-Back.md`. Ver criterios J1-J2, Reglas 1 y 5 en `TPSC-RE-FU-022-Pendiente.md`. Es el contraparte peruano de la Tarea 10 de RE-FU-021.

**Recursos:**
- `TPSC-RE-FU-022-Back.md` — Parte B, flujo PersistirFacturaPeruPdfService
- `TPSC-RE-FU-022-Pendiente.md` — Criterios J1-J2, Reglas 1 y 5
- TPSC-RE-FU-021 Tarea 10 — `PersistirFacturaMexicoPdfService` (patrón equivalente)
...
**Más información de la tarea:**
Ver sección *"Integración con RE-FU-020 — branch PER"* en `TPSC-RE-FU-022-Back.md`. Ver Tarea 11 de RE-FU-021 (patrón equivalente para México).

**Recursos:**
- `TPSC-RE-FU-022-Back.md` — Parte B, integración branch PER FacturaAdelantadoGenerarService
- TPSC-RE-FU-021 Tarea 11 — `FacturaAdelantadoGenerarService` MEX (patrón equivalente)
...
**Más información de la tarea:**
Ver sección *"Integración con RE-FU-020 — branch PER Preview"* en `TPSC-RE-FU-022-Back.md`. Ver Tarea 12 de RE-FU-021 (patrón equivalente para México).

**Recursos:**
- `TPSC-RE-FU-022-Back.md` — Parte B, integración branch PER FacturaAdelantadoPreviewService
- TPSC-RE-FU-021 Tarea 12 — `FacturaAdelantadoPreviewService` MEX (patrón equivalente)
...
**Más información de la tarea:**
Ver sección *"GAP-07 — Validar Cobro Perú"* en `TPSC-RE-FU-022-Back.md`. Ver Tarea 13 de RE-FU-021 (patrón equivalente para México). Ver alcance en `TPSC-RE-FU-022-Pendiente.md` (facturas originadas en Validar Cobro Perú).

**Recursos:**
- `TPSC-RE-FU-022-Back.md` — GAP-07 Validar Cobro Perú
- `TPSC-RE-FU-022-Pendiente.md` — Alcance, Criterios J1-J2
- TPSC-RE-FU-021 Tarea 13 — Integración Validar Cobro México (patrón equivalente)
