...
| B2 | REF.CLIENTE Peru no definida | PDF sin referencia de pago | Definir logica de identificacion de pagos para bancos peruanos |
| B3 | Direccion legal GOLPERU no capturada | Pie del PDF incompleto | Recopilar y UPDATE Empresa (GOLPERU) |
| B4 | Disclaimer SUNAT no validado legalmente | Riesgo legal | Validar con asesor contable peruano |
| B5 | Detracciones/Percepciones no confirmadas | Posible omision regulatoria | Confirmar con asesor contable peruano |
| B7 | Certificaciones GOLPERU Peru desconocidas | Pie del PDF incompleto | Confirmar ISO/metodos de pago Peru |
| B8 | Logos farmaceuticos Peru no definidos | Pie del PDF incompleto | Confirmar lista (USP, EDQM, Microbiologics) |
| B10 | Titulo: Proforma vs Factura Proforma | Ambiguedad documento | Confirmar con cliente |
| B11 | Nomenclatura: SOLES vs NUEVOS SOLES | Texto en letra incorrecto | Confirmar (SOLES es oficial desde 2015) |
| B12 | TC SUNAT compra/venta vs interno | Monto puede variar | Confirmar con finanzas |
...
| Requisito | Relacion |
|-----------|----------|
| TPSC-RE-FU-016 | Comparte FolioProforma, SeqFolioProforma, vtpProformaPedido, patron Archivo |
| TPSC-RE-FU-001 | EmpresaDatosBancarios.IdRegion (filtrar cuentas PER) |
| TPSC-RE-FU-006 | ClienteDatosBancarios - logica REF.CLIENTE Peru (BRECHA) |
| TPSC-RE-FU-013 | Flujo Prepago con controlados (mismo PDF Peru) |
