...
| Tarea 1 | TPSC-RE-FU-007 | ALTER FUNCTION `fnEsProductoControlado` — agregar `'origen'` | **Ya existe en RE-FU-007 Tarea 1.** No crear script duplicado. Es prerequisito de este requisito. |
...
# [ TPSC-RE-FU-009 ] [ALG-BASIC-LOGIC] Crear ValidarDocumentosRegulatoriosBO — lógica de validación regulatoria
...
- Referencia: `TPSC-RE-FU-009-Back.md` — PARTE 2, secciones 2.3 y 2.5
...
- Queries de referencia: `TPSC-RE-FU-009_BD.md` — secciones "Consulta SQL"
...
# [ TPSC-RE-FU-009 ] [ALG-BASIC-LOGIC] Crear ResultadoValidacionRegulatoria — DTO de resultado
...
- Referencia: `TPSC-RE-FU-009-Back.md` — PARTE 2, sección 2.3
...
# [ TPSC-RE-FU-009 ] [IMP-EXIST-SERVICE] Modificar VerificarPedidoTramitableBO — integrar validación regulatoria
...
- Referencia: `TPSC-RE-FU-009-Back.md` — PARTE 2, sección 2.4 (OBS-023)
...
- Referencia: `TPSC-RE-FU-009-Back.md` — PARTE 2, sección 2.4
...
# [ TPSC-RE-FU-009 ] [UPDATE-TABL-CH] Script BD: INSERT catUsoArchivoSistema — documentos regulatorios PER
...
- Referencia: `TPSC-RE-FU-009_BD.md` — sección "catUsoArchivoSistema"
- Gap: `TPSC-RE-FU-009-Back.md` — PARTE 7, Gap #1
...
# [ TPSC-RE-FU-009 ] [UPDATE-TABL-CH] ALTER TABLE ppPedido + tpPedido — campos entregas parciales y pedido hijo (OBS-023)
...
- Referencia: `TPSC-RE-FU-009_BD.md` — sección "Cambios Estructurales (OBS-023)"
...
# [ TPSC-RE-FU-009 ] [ALG-COMPLX-LOGIC] Implementar bifurcación de entregas parciales en TramitarPedidoBO (OBS-023)
...
- OBS-023
- Referencia: `TPSC-RE-FU-009-Back.md` — PARTE 2, sección 2.2 y 2.4
...
# [ TPSC-RE-FU-009 ] [SERV-TRANSACT] Crear pedido hijo para partidas controladas retenidas (OBS-023)
...
- OBS-023
- Referencia: `TPSC-RE-FU-009-Back.md` — PARTE 2, sección 2.3 (componente 3)
