...
| Requisito | Relacion |
|-----------|----------|
| TPSC-RE-FU-024 | Paso 1 MEX (fccPagoCliente confirmado, catTipoInconsistenciaCobro) |
| TPSC-RE-FU-023 | fccPagoCliente -> fccPagoFacturaPedido (Validar Cobro) |
