...
- La tabla existe con la estructura definida en `TPSC-RE-FU-026_BD.md`.
...
Ver sección *"Parte A / A1"* en `TPSC-RE-FU-026-Back.md` y sección *"Tabla Nueva: fccSaldoFavorCliente"* en `TPSC-RE-FU-026_BD.md`.

**Recursos:**
- `TPSC-RE-FU-026_BD.md` — DDL fccSaldoFavorCliente
- `TPSC-RE-FU-026-Back.md` — Parte A, sección A1
...
**Más información de la tarea:**
Ver sección *"Parte A / A2"* en `TPSC-RE-FU-026-Back.md` y sección *"Vinculo NC con Cobro"* en `TPSC-RE-FU-026_BD.md`.

**Recursos:**
- `TPSC-RE-FU-026_BD.md` — ALTER fccNotaCredito
- `TPSC-RE-FU-026-Back.md` — Parte A, sección A2
...
**Más información de la tarea:**
Ver sección *"Parte A / A3"* en `TPSC-RE-FU-026-Back.md` y sección *"Inconsistencias Paso 2"* en `TPSC-RE-FU-026_BD.md`.

**Recursos:**
- `TPSC-RE-FU-026_BD.md` — ALTER catTipoInconsistenciaCobro
- `TPSC-RE-FU-026-Back.md` — Parte A, sección A3
...
**Más información de la tarea:**
Ver sección *"Parte B / B1"* en `TPSC-RE-FU-026-Back.md`. Ver regla 4 en `TPSC-RE-FU-026.md`.

**Recursos:**
- `TPSC-RE-FU-026-Back.md` — Parte B, sección B1
- `TPSC-RE-FU-026_BD.md` — Tablas de asociación existentes
...
**Más información de la tarea:**
Ver sección *"Parte B / B2"* en `TPSC-RE-FU-026-Back.md`. Ver regla 6 en `TPSC-RE-FU-026.md`.

**Recursos:**
- `TPSC-RE-FU-026-Back.md` — Parte B, sección B2
- `TPSC-RE-FU-026_BD.md` — fccNotaCredito existente
...
**Más información de la tarea:**
Ver sección *"Parte B / B3"* en `TPSC-RE-FU-026-Back.md`. Ver reglas 7-11 y criterio de multi-divisa en `TPSC-RE-FU-026.md`.

**Recursos:**
- `TPSC-RE-FU-026-Back.md` — Parte B, sección B3
- `TPSC-RE-FU-026.md` — Reglas 7-11, 19, 20
...
**Más información de la tarea:**
Ver sección *"Parte B / B4"* en `TPSC-RE-FU-026-Back.md`. Ver reglas 8-11 en `TPSC-RE-FU-026.md`.

**Recursos:**
- `TPSC-RE-FU-026-Back.md` — Parte B, sección B4
- `TPSC-RE-FU-026_BD.md` — Tablas de asociación + fccSaldoFavorCliente
...
**Más información de la tarea:**
Ver sección *"Parte B / B5"* en `TPSC-RE-FU-026-Back.md`. Ver reglas 12-14 en `TPSC-RE-FU-026.md`.

**Recursos:**
- `TPSC-RE-FU-026-Back.md` — Parte B, sección B5
- `TPSC-RE-FU-026_BD.md` — catTipoInconsistenciaCobro + AplicaMarkPendienteCancelacion
- `TPSC-RE-FU-024-Tareas.md` — Tarea 10 (base del modal a extender)
...
**Más información de la tarea:**
Ver sección *"Parte B / B6"* en `TPSC-RE-FU-026-Back.md`. Ver reglas 15 y 16 en `TPSC-RE-FU-026.md`.

**Recursos:**
- `TPSC-RE-FU-026-Back.md` — Parte B, sección B6
- `TPSC-RE-FU-026.md` — Reglas 15 y 16
