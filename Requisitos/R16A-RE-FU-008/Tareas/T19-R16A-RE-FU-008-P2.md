# [ R16A-RE-FU-008 ] [ALG-COMPLX-LOGIC] Implementar Mailbot.Application — casos de uso y DTOs
...
- Referencia: `R16A-RE-FU-008-P2-Back.md` — PARTE 2, sección 2.6 (Flujo end-to-end)
- Referencia: `R16A-RE-FU-008-v2_Propuesta2.md` — secciones "Lógica de Reintentos" y "Arquitectura"
