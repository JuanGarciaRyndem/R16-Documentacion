# R16A-RE-FU-008 — Tareas de Implementación Backend
...
| **Total de tareas** | 12 |
| **Revisión aplicada** | R16A-RE-FU-008-Back.md |
...
### R16A-RE-FU-008  [ BD-OBJ-CH ]  Script de migración de catálogos para Buzón de Cobros
...
- GAP-01 del archivo `R16A-RE-FU-008-Back.md`
...
**Recursos:**
- Análisis de impacto backend: `Requisitos/R16A-RE-FU-008/R16A-RE-FU-008-Back.md`
- Diccionario de datos: `Requisitos/R16A-RE-FU-008/R16A-RE-FU-008_BD.md`
- Requisito funcional: `Requisitos/R16A-RE-FU-008/R16A-RE-FU-008.md`

---

## Tarea 2

### R16A-RE-FU-008  [ IMP-EXIST-SERVICE ]  Crear constantes de clasificación y refactorizar switch del MailBot
...
**Más información de la tarea:**
- GAP-02 del archivo `R16A-RE-FU-008-Back.md`
...
### R16A-RE-FU-008  [ LIST-PAG-MULT-FILTER ]  CorreoRecibidoClienteBuzonCobrosBO — listado paginado del Buzón de Cobros
...
**Más información de la tarea:**
- GAP-03 del archivo `R16A-RE-FU-008-Back.md`
...
### R16A-RE-FU-008  [ QUERY-CH ]  BuzonCobrosController — endpoint POST /BuzonCobros con QueryInfo
...
**Más información de la tarea:**
- GAP-04 del archivo `R16A-RE-FU-008-Back.md`
...
### R16A-RE-FU-008  [ IMP-EXIST-SERVICE ]  Proceso de Clasificación de Cobros — completar CorreoRecibidoClienteToPagoBO
...
**OBS-021 — Correos no enrutables:** Si el cliente no tiene Cobrador (Caso 1) o el remitente no está dado de alta (Caso 2), el folio se crea igualmente y el correo aparece en la bandeja del Coordinador de Tesorería (Tarea 8). Registrar en log con motivo. Ver GAP-06 en `R16A-RE-FU-008-Back.md`.
...
### R16A-RE-FU-008  [ ALG-COMPLX-LOGIC ]  Proceso de Integración y Validación de Cobros — ValidacionCobroBO
...
### R16A-RE-FU-008  [ IMP-EXIST-SERVICE ]  Entrenamiento del MailBot — agregar categoría Cobro al modelo de clasificación
...
- Requisito funcional: `Requisitos/R16A-RE-FU-008/
---

## Tarea 8

### R16A-RE-FU-008  [ LIST-PAG-MULT-FILTER ]  BandejaCoordenadorTesoreriaBO — correos de cobro no enrutables
...
**Cambios requeridos:**
Ver fragmento de código en GAP-05 de `R16A-RE-FU-008-Back.md`.
...
**Más información de la tarea:**
- GAP-05 del archivo `R16A-RE-FU-008-Back.md`
...
### R16A-RE-FU-008  [ QUERY-CH ]  BandejaCoordenadorTesoreriaController — endpoint POST /BandejaCoordenadorTesoreria
...
### R16A-RE-FU-008  [ QUERY-G ]  Análisis ETL Legacy — Mapeo de datos Buzón de Cobros y definición de trigger
...
**Consideraciones previas:**
- ⚠️ **Brecha B3 BLOQUEANTE (compartida con R16A-RE-FU-028):** El canal de transferencia a Legacy (tabla ETL, cola RabbitMQ, API directa) no está definido. Esta tarea contribuye a su resolución desde la perspectiva del Buzón de Cobros.
- La transferencia E1 (Datos Buzón de Cobros) está documentada en `R16A-RE-FU-028-Back.md` Parte E como dependencia de RE-008. Esta tarea define el **qué y cuándo** desde el origen.
...
- Actualización de la sección E1 en `R16A-RE-FU-028-Back.md` con los acuerdos alcanzados
...
**Más información de la tarea:**
Ver E1 en `R16A-RE-FU-028-Back.md` — Parte E y Brecha B3. Los archivos adjuntos del correo se acceden desde `ArchivoCorreoRecibido` (N:N) — NO solo desde `fccFolioPagoCliente.IdArchivo`. Los archivos están en MinIO bucket `mailbot` y se recuperan vía `ArchivoBO.Obtener(IdArchivo)`.

**Recursos:**
- `R16A-RE-FU-008-Back.md` — GAP-02, GAP-03, GAP-06 (modelo de datos del Buzón)
- `R16A-RE-FU-008_BD.md` — tablas: `fccFolioPagoCliente`, `ArchivoCorreoRecibido`, `Archivo`
- `Logic.Pqf.Logistica/L11.MailBot/Archivos/ArchivoCorreoRecibidoBO.cs` — lógica existente de archivos en MinIO
- `R16A-RE-FU-028-Back.md` — Parte E, E1, Brecha B3
- Requisito funcional: `R16A-RE-FU-008.md`

---

## Tarea 11

### R16A-RE-FU-008  [ SERV-COMPLEX-TRANSACT ]  Implementar payload builder ETL E1 (Buzón de Cobros) e interfaz IEtlBuzonCobrosLegacyService
...
- Coordinación con `R16A-RE-FU-028 T18`: si el canal general `IEtlLegacyTransferenciaService` ya fue implementado allá, evaluar si E1 se integra como tipo adicional al mismo servicio o como servicio independiente.
...
**Más información de la tarea:**
El mapeo columna-a-columna para construir el payload proviene del análisis de Tarea 10. Coordinar con R16A-RE-FU-028 T18 para evitar duplicación de la interfaz general de canal ETL.

**Recursos:**
- `R16A-RE-FU-008-Back.md` — GAP-03, GAP-06, modelo `fccPagoCliente`, `fccBuzonCobro`
- `R16A-RE-FU-008_BD.md` — tablas fuente ETL
- `R16A-RE-FU-028-Back.md` — Parte E, E1, Brecha B3
...
### R16A-RE-FU-008  [ SERV-TRANSACT ]  Canal ETL Legacy definitivo Buzón de Cobros (E1) — integración, pruebas y documentación
...
- Requiere que el canal de transferencia esté definido (resultado de R16A-RE-FU-028 T17 o de Tarea 10 si B3 se resuelve desde aquí).
...
**Objetivos específicos:**
- Implementar `EtlBuzonCobrosLegacyService` real según el mecanismo definido en Tarea 10 y R16A-RE-FU-028 T17.
...
- Actualizar la sección E1 en `R16A-RE-FU-028-Back.md` confirmando la implementación como completada.
...
- Actualización de E1 en `R16A-RE-FU-028-Back.md` como implementado
...
- [ ] E1 actualizado como implementado en `R16A-RE-FU-028-Back.md`.

**Más información de la tarea:**
Esta tarea cierra el ciclo ETL de RE-008 para Legacy. El resto de los ETL del flujo Validar Cobro (E2 Proforma, E3 Factura, E6 PDF) se implementan en R16A-RE-FU-028 T18/T19.

**Recursos:**
- `R16A-RE-FU-008-Back.md` — GAP-03, GAP-06, modelo `fccPagoCliente`, `fccBuzonCobro`
- `R16A-RE-FU-008_BD.md` — tablas fuente ETL
- `R16A-RE-FU-028-Back.md` — Parte E, E1, Brecha B3, Consideraciones transversales ETL
