# Diccionario de Datos — TPSC-RE-FU-004 Información Fiscal del Cliente
...
> **Pendiente:** No existen registros para Región Perú. Requiere carga de catálogo SUNAT. Ver archivo `TPSC-RE-FU-004_Equivalencias_MX_PE.xlsx` para detalle de discrepancias.
