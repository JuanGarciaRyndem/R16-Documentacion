...
> ** La consolidación definitiva de las listas está pendiente de validación con el cliente. Ver archivo adjunto `TPSC-RE-FU-004_Equivalencias_MX_PE.xlsx`. **
...
>
> Ver archivo adjunto `TPSC-RE-FU-004_Equivalencias_MX_PE.xlsx` con el detalle del cruce y las observaciones por código y opción.
...
Para el detalle completo del estado actual de los catálogos en PQF2, el cruce con el archivo entregado por el cliente y la verificación contra el catálogo vigente del SAT, ver archivo adjunto `TPSC-RE-FU-004_Equivalencias_MX_PE.xlsx`.
