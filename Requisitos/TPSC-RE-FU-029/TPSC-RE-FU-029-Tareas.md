...
>
> **Dependencias externas:** TPSC-RE-FU-028 completo (catálogos, `fccDocumentoFiscalCobro`, `fccConfirmacionPedido`, `CFDIGenerada` con `IdCatTipoCFDI`, `vfccDocumentoFiscalCobro` v1 y `tpPedido.FechaEstimadaEntrega` aplicados). TPSC-RE-FU-026 completo (`fccPagoFacturaPedido`, `fccPagoFacturaAdelanto`). TPSC-RE-FU-020 completo (`FacturaPdfMappingService` Perú, `GOLPERU_PER_FAC`).
>
> **Brechas bloqueantes activas:** B1 (modalidad emisión SUNAT indefinida) bloquea T5 y T9. B4 (datos fiscales SUNAT del producto) bloquea T9. Las tareas T5 y T9 pueden prepararse en estructura pero no pueden probarse en producción hasta resolver B1 y B4. Ver `TPSC-RE-FU-029_BD.md` y `TPSC-RE-FU-029-Back.md` — sección Brechas.
>
...
- `catTipoOperacionSUNAT` existe con la estructura definida en `TPSC-RE-FU-029_BD.md`.
...
Ver sección *"Catálogo Nuevo: catTipoOperacionSUNAT"* en `TPSC-RE-FU-029_BD.md` y sección *"Parte A / A1"* en `TPSC-RE-FU-029-Back.md`.

**Recursos:**
- `TPSC-RE-FU-029_BD.md` — DDL + DML catTipoOperacionSUNAT
- `TPSC-RE-FU-029-Back.md` — Parte A, sección A1
...
**Más información de la tarea:**
Ver sección *"ALTER TABLE catTipoCFDI — Agregar IdRegion + FACTURA_CPE"* en `TPSC-RE-FU-029_BD.md` y sección *"Parte A / A2"* en `TPSC-RE-FU-029-Back.md`.

**Recursos:**
- `TPSC-RE-FU-029_BD.md` — ALTER TABLE catTipoCFDI
- `TPSC-RE-FU-029-Back.md` — Parte A, sección A2
...
**Más información de la tarea:**
Ver sección *"ALTER TABLE fccDocumentoFiscalCobro — Columnas Perú"* en `TPSC-RE-FU-029_BD.md` y sección *"Parte A / A3"* en `TPSC-RE-FU-029-Back.md`.

**Recursos:**
- `TPSC-RE-FU-029_BD.md` — ALTER TABLE fccDocumentoFiscalCobro
- `TPSC-RE-FU-029-Back.md` — Parte A, sección A3
...
**Más información de la tarea:**
Ver sección *"ALTER VIEW vfccDocumentoFiscalCobro — Extensión Perú (v2.0)"* en `TPSC-RE-FU-029_BD.md` y sección *"Parte A / A4"* en `TPSC-RE-FU-029-Back.md`.

**Recursos:**
- `TPSC-RE-FU-029_BD.md` — ALTER VIEW vfccDocumentoFiscalCobro
- `TPSC-RE-FU-029-Back.md` — Parte A, sección A4
...
**Más información de la tarea:**
Ver sección *"Parte C / C1"* en `TPSC-RE-FU-029-Back.md` y sección *"EmpresaFolio GOLPERU"* en `TPSC-RE-FU-020_BD.md`.

**Recursos:**
- `TPSC-RE-FU-029-Back.md` — Parte C, sección C1
- `TPSC-RE-FU-020_BD.md` — EmpresaFolio GOLPERU (patrón Serie/Correlativo)
...
**Más información de la tarea:**
Ver sección *"Parte B / B1"* en `TPSC-RE-FU-029-Back.md`.

**Recursos:**
- `TPSC-RE-FU-029-Back.md` — Parte B, sección B1
- `TPSC-RE-FU-028-Back.md` — Parte B, sección B1 (patrón de referencia México)
...
**Más información de la tarea:**
Ver sección *"Parte B / B2"* en `TPSC-RE-FU-029-Back.md`.

**Recursos:**
- `TPSC-RE-FU-029-Back.md` — Parte B, sección B2
- `TPSC-RE-FU-028-Back.md` — Parte B, sección B2 (patrón análogo México)
...
**Más información de la tarea:**
Ver sección *"Parte B / B3"* en `TPSC-RE-FU-029-Back.md` y `FacturaPdfMappingService` Perú en TPSC-RE-FU-020.

**Recursos:**
- `TPSC-RE-FU-029-Back.md` — Parte B, sección B3
- `TPSC-RE-FU-020-Back.md` / `TPSC-RE-FU-020-Tareas.md` — FacturaPdfMappingService Perú, GOLPERU_PER_FAC
...
**Más información de la tarea:**
Ver sección *"Parte B / B4"* en `TPSC-RE-FU-029-Back.md`.

**Recursos:**
- `TPSC-RE-FU-029-Back.md` — Parte B, sección B4; Brechas B1 y B4
- `TPSC-RE-FU-028-Back.md` — Parte B, sección B4 Escenario A (patrón de referencia sin cascada)
...
**Más información de la tarea:**
Ver sección *"Parte B / B5"* en `TPSC-RE-FU-029-Back.md`.

**Recursos:**
- `TPSC-RE-FU-029-Back.md` — Parte B, sección B5
- `TPSC-RE-FU-028-Tareas.md` — Tarea 14 (patrón de referencia modal envío México)
...
- Comentar: `// Perú no transfiere a Legacy — ver Regla 11 de TPSC-RE-FU-029`.
...
**Más información de la tarea:**
Ver secciones *"Parte B / B6.1 y B6.2 y B6.3"* en `TPSC-RE-FU-029-Back.md`. Comparar con RE-FU-028 Tarea 15 (FEE + CDP) y Tarea 17 (ETL Legacy — que NO existe para Perú).

**Recursos:**
- `TPSC-RE-FU-029-Back.md` — Parte B, secciones B6.1, B6.2, B6.3
- `TPSC-RE-FU-028-Tareas.md` — Tarea 15 (patrón FEE + CDP de México como referencia)
...
**Más información de la tarea:**
Ver sección *"Parte B / B7"* en `TPSC-RE-FU-029-Back.md`. Ver TPSC-RE-FU-028 Tarea 16 como referencia.

**Recursos:**
- `TPSC-RE-FU-029-Back.md` — Parte B, sección B7
- `TPSC-RE-FU-028-Tareas.md` — Tarea 16 (patrón de cierre wizard México)
