# Impacto en Back — TPSC-RE-FU-030
...
> Ver script completo en `TPSC-RE-FU-030_BD.md` — Catálogo: catFormaPagoSAT.
...
> Ver script completo en `TPSC-RE-FU-030_BD.md` — DML catUsoCFDI.
...
> Ver script completo en `TPSC-RE-FU-030_BD.md` — ALTER TABLE fccDocumentoFiscalCobro.
...
> Ver script completo en `TPSC-RE-FU-030_BD.md` — DML EmpresaFolio.
...
> Ver script completo en `TPSC-RE-FU-030_BD.md` — DML DocumentTemplate.
...
> Ver script completo en `TPSC-RE-FU-030_BD.md` — ALTER VIEW vfccDocumentoFiscalCobro v3.0.
