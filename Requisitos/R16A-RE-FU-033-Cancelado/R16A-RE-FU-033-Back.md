...
Ver `R16A-RE-FU-033_BD.md` para scripts completos.
...
> **Nota:** Mientras no se confirme el alcance, este filtro no debe implementarse. Cuando se resuelva, agregar el mismo JOIN de `vUsuarioCartera` que en RE-032 B7 (Criterio A5). Referencia de diseño: R16A-RE-FU-002 Módulos Consumidores.
...
- El diseño visual se documenta en R16A-RE-FU-035.
