# Diccionario de Datos — R16A-RE-FU-007 Notificación Regulatoria en Cotización Definitiva
...
**Función requerida por R16A-RE-FU-007 (debe incluir Origen):**
...
|--------|-----------|----------|
| Catálogo de Clientes — Docs Regulatorios | R16A-RE-FU-003 | La leyenda avisa al cliente que debe tener estos docs cargados |
| Pretramitar Pedido | R16A-RE-FU-009 | Valida bloqueantemente que el cliente tenga los docs cargados |
